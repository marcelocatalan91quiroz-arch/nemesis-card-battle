...
const CABALLEROS_SUBMUNDO_CARDS=[
 ...
 ,{id:'CS-011',name:'Luz de Ares',atk:0,def:0,type:'magic',subtype:'weapon',family:'caballeros-submundo',tags:['arma','ares','perforacion','caballeros-submundo'],rarity:'divina-suprema',effect:'csWeaponAresLight',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/luz-de-ares.webp',equipAtk:3000,desc:'FILO DEL DIOS DE LA GUERRA: +3000 ATK; contra DEF superior al ATK original obtiene +2000 ATK durante ese combate. RUPTURA DE ARES: una vez por turno reduce 2500 DEF del objetivo al atacar. SED DE BATALLA: al destruir en combate +1000 ATK permanente, máximo +3000. CONTRAOFENSIVA DIVINA: si sobrevive a un ataque, su siguiente ataque obtiene Perforación. SINERGIA DEL SUBMUNDO: las versiones Shiny pueden sustituir una destrucción por efecto una vez por duelo. JUICIO DE ARES: una vez por duelo +5000 ATK temporal, Perforación Total y 2000 HP directo si destruye.'}
 ,{id:'CS-012',name:'Sentencia de Venuz',atk:0,def:0,type:'magic',subtype:'weapon',family:'caballeros-submundo',tags:['arma','venuz','eclipse','control','caballeros-submundo'],rarity:'divina-suprema',effect:'csWeaponVenuzSentence',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/sentencia-de-venuz.webp',equipAtk:3500,desc:'FILO DEL VEREDICTO: +3500 ATK y puede reducir 2000 DEF al iniciar combate. MARCA DEL CONDENADO: una vez por turno marca una criatura que no puede recibir bonos ATK/DEF de equipamiento. SENTENCIA INAPELABLE: si destruye al marcado queda CONDENADO 2 turnos. VOLUNTAD DE VENUZ: una vez por duelo el arma se destruye en lugar del portador. SOBERANÍA DEL ECLIPSE: Venuz/Venuz Shiny reciben +1500 ATK/+1500 DEF adicional; Shiny niega la primera anulación dirigida al arma por turno. VEREDICTO DEL ECLIPSE: una vez por duelo +5000 ATK, Perforación y 2500 HP directo si ejecuta al objetivo.'}
 ,{id:'CS-013',name:'Aguijón de Escorpión',atk:0,def:0,type:'magic',subtype:'weapon',family:'caballeros-submundo',tags:['arma','veneno','escorpion','caballeros-submundo'],rarity:'divina-suprema',effect:'csWeaponScorpionSting',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/aguijon-de-escorpion.webp',equipAtk:2500,equipDef:2000,desc:'AGUIJÓN VENENOSO: +2500 ATK y cada impacto aplica VENENO. VENENO DEL SUBMUNDO: -1000 ATK/-1000 DEF al comienzo del turno durante 3 turnos. NEUROTOXINA: una vez por turno contra un objetivo envenenado bloquea una habilidad durante el combate. CAPARAZÓN DEL ESCORPIÓN: +2000 DEF; si sobrevive a un ataque envenena al atacante. VENENO ACUMULATIVO: segunda aplicación activa 1000 HP directo. PICADURA DE LA MUERTE: una vez por duelo +4000 ATK, Perforación, 3 cargas de Veneno y 2000 HP directo si destruye.'}
 ,{id:'CS-014',name:'Agujero Negro',atk:0,def:0,type:'magic',subtype:'weapon',family:'caballeros-submundo',tags:['arma','singularidad','gravedad','control','caballeros-submundo'],rarity:'divina-absoluta',effect:'csWeaponBlackHole',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/agujero-negro.webp',equipAtk:3000,equipDef:2000,desc:'NÚCLEO DE SINGULARIDAD: +3000 ATK/+2000 DEF y esos bonos no pueden reducirse. ATRACCIÓN GRAVITACIONAL: una vez por turno reduce 30% del ATK/DEF actual de 1 enemigo hasta final del turno. DEVORADOR DE PODER: al destruir en combate +500 ATK/+500 DEF permanente, máximo +3000/+3000. HORIZONTE DE SUCESOS: niega una vez por turno un efecto que intente retirar, devolver, desterrar o destruir el arma. COLAPSO GRAVITACIONAL: una vez por turno una criatura enemiga recién invocada no puede atacar. SINGULARIDAD ABSOLUTA: una vez por duelo +5000 ATK/+3000 DEF, Perforación, -2000 ATK/-2000 DEF a enemigos, atrapa temporalmente 1 criatura y cura 1500 HP si destruye.'}
 ,{id:'CS-015',name:'Armadura Olvidada',atk:0,def:0,type:'magic',subtype:'armor',family:'caballeros-submundo',tags:['armadura','memoria','defensa','caballeros-submundo'],rarity:'divina-suprema',effect:'csArmorForgotten',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/armadura-olvidada.webp',equipDef:4000,desc:'MEMORIA DEL OLVIDO: +4000 DEF y acumula hasta 3 MEMORIAS al sobrevivir ataques. ADAPTACIÓN ANCESTRAL: por MEMORIA +500 ATK/+500 DEF mientras siga equipada; con 3 MEMORIAS, Perforación en el próximo ataque. NEGARSE A MORIR: una vez por duelo evita destrucción y permanece con 1 DEF, consumiendo MEMORIAS. CADENAS DEL PASADO: una vez por turno reduce en 50% una penalización enemiga de ATK/DEF. HERENCIA DEL SUBMUNDO: con 3 Caballeros distintos entre Campo y Cementerio +1500 DEF. ULTIMATE EL GUERRERO QUE EL MUNDO OLVIDÓ: requiere y consume 3 MEMORIAS; 2 turnos +4000 ATK/+5000 DEF, protección de efecto una vez por turno, reduce 70% el primer daño de combate y habilita Perforación tras sobrevivir.'}
 ,{id:'CS-016',name:'Armadura Forjada de Plutón',atk:0,def:0,type:'magic',subtype:'armor',family:'caballeros-submundo',tags:['armadura','pluton','forja','contraataque','caballeros-submundo'],rarity:'divina-suprema',effect:'csArmorPlutoForge',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/armadura-forjada-pluton.webp',equipAtk:1500,equipDef:3500,desc:'FORJA DE PLUTÓN: +3500 DEF/+1500 ATK y obtiene hasta 3 CARGAS DE FORJA al sobrevivir ataques. METAL DEL INFRAMUNDO: por carga recibe 500 menos de daño; con 3 cargas niega la primera reducción de ATK/DEF del turno. PODER DE LOS CAÍDOS: una vez por turno gana hasta fin de turno 20% del ATK base de 1 Caballero del Submundo del Cementerio. VENGANZA DE PLUTÓN: al sobrevivir, siguiente ataque +2000 ATK; con 3 cargas también Perforación y luego consume las cargas. ARMADURA DEL REY DEL INFRAMUNDO: una vez por duelo niega destrucción o destierro por habilidad y gana +2000 DEF permanente mientras siga equipada. ULTIMATE FORJA DEL REY PLUTÓN: requiere 3 cargas; durante 2 turnos +4000 ATK/+5000 DEF, reduce 50% daño de combate, contraataca 50% del daño mitigado y niega la primera destrucción por efecto.'}
 ,{id:'CS-017',name:'Corazón del Tártaro',atk:0,def:0,type:'magic',subtype:'relic',family:'caballeros-submundo',tags:['reliquia','tartaro','almas','mitica-suprema','caballeros-submundo'],rarity:'mitica-suprema',effect:'csRelicTartarusHeart',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/corazon-del-tartaro.webp',desc:'ALMAS ENCADENADAS: cada Caballero del Submundo enviado al Cementerio añade 1 ALMA, máximo 5. Cada ALMA concede +300 ATK/+300 DEF a todos tus Caballeros; con 5 ALMAS añade +500 ATK/+500 DEF extra. RESERVA DE LAS ALMAS: permite consumir 1 ALMA para proteger temporalmente a un Caballero del Cementerio. CORAZÓN INMORTAL: puede consumir 2 ALMAS para resistir su destrucción. SINFONÍA DEL INFRAMUNDO: protege el poder de tus Caballeros contra reducciones y selección hostil. ULTIMATE PUERTAS DEL TÁRTARO: una vez por duelo con 5 ALMAS, consume las 5 e invoca 1 Caballero del Submundo desde tu Cementerio.'}
 ,{id:'CS-018',name:'Trono de las Almas Perdidas',atk:0,def:0,type:'magic',subtype:'relic',family:'caballeros-submundo',tags:['reliquia','trono','almas-enemigas','ancestral-suprema','caballeros-submundo'],rarity:'ancestral-suprema',effect:'csRelicLostSoulsThrone',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/trono-almas-perdidas.webp',desc:'REINO DE LOS MUERTOS: cada monstruo enemigo destruido alimenta el Trono con 1 ALMA ENEMIGA, máximo 5; cada una reduce -300 ATK/-300 DEF a los monstruos enemigos. TRONO MALDITO: con 3 ALMAS ENEMIGAS niega automáticamente la primera Mágica o Trampa rival de cada turno. PESO DEL JUICIO: con 2 o más ALMAS ENEMIGAS bloquea aumentos de ATK/DEF enemigos. CORRUPCIÓN DEL ALMA: puede consumir 1 ALMA ENEMIGA para llevar un monstruo rival a 0 ATK/0 DEF hasta final del turno. TRONO INQUEBRANTABLE: una vez por duelo niega su destrucción y gana 1 ALMA ENEMIGA. ULTIMATE JUICIO DEL INFRAMUNDO: una vez por duelo con 3 ALMAS ENEMIGAS, consume las 3 y somete 1 monstruo enemigo durante 1 turno.'} ,{id:'CS-019',name:'Escudo de Luna',atk:0,def:0,type:'magic',subtype:'spell',family:'caballeros-submundo',tags:['magica','luna','proteccion','resurreccion','caballeros-submundo'],rarity:'divina-absoluta',effect:'csMagicMoonShield',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/escudo-de-luna.webp',desc:'BARRERA DE LA LUNA ETERNA: durante 1 turno tus Caballeros no pueden ser destruidos por combate ni efectos. REFLEJO DEL ECLIPSE: protege contra el primer efecto hostil y debilita al agresor. LUNA DE LOS CAÍDOS: +500 ATK/+500 DEF por Caballero del Submundo en el Cementerio, máximo +2500/+2500. RESPLANDOR DE RESURRECCIÓN: invoca 1 Caballero desde el Cementerio si hubo una caída. CASTIGO LUNAR: prepara un contraataque reforzado. ULTIMATE ECLIPSE DE LA LUNA INMORTAL: una vez por duelo con 3 Caballeros entre Campo y Cementerio, protege el Campo, recupera 3000 HP, resucita 1 Caballero y concede +3000 ATK/+3000 DEF hasta el siguiente turno.'}
 ,{id:'CS-020',name:'Rayo del Submundo',atk:0,def:0,type:'magic',subtype:'spell',family:'caballeros-submundo',tags:['magica','rayo','destruccion','ejecucion','caballeros-submundo'],rarity:'divina-absoluta',effect:'csMagicUnderworldRay',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/rayo-del-submundo.webp',desc:'RAYO DE LOS CONDENADOS: -5000 ATK/-5000 DEF a 1 enemigo; si DEF llega a 0, lo destruye. PODER DE LAS ALMAS: +1000 de reducción por Caballero del Submundo en tu Cementerio, máximo 5. DESCARGA DEL INFRAMUNDO: si destruye, causa 2500 HP directo o 3500 contra rareza Divina o superior. JUICIO SOBRE LOS INMORTALES: sella al objetivo que sobreviva por protección. ULTIMATE TORMENTA DEL FIN DEL SUBMUNDO: una vez por duelo con 5 Caballeros entre Campo y Cementerio, reduce -5000/-5000 a todos los enemigos y aplica un segundo impacto al objetivo principal.'}
...
const STRATEGIC_REDEEM_CARDS=[
 ...
 {id:'strategic-prometeo',name:'Prometeo — Portador del Fuego Eterno',atk:10000,def:9000,type:'monster',family:'universal',tags:['fuego','titan','divina','universal','canje'],rarity:'ancestral',level:10,effect:'strategicPrometheus',strategicRedeem:true,priceStars:1700,img:'assets/images/strategic/prometeo.jpg',desc:'FUEGO DE LOS DIOSES: reduce 2000 DEF a 1 rival este turno. TITÁN ENCADENADO: evita su primera destrucción. REGALO PROHIBIDO: +2000 ATK/+2000 DEF durante 2 turnos. LLAMA PRIMORDIAL: tras 3 turnos en Campo, una vez por duelo destruye 1 monstruo rival e inflige 1500 HP.'},
 ...
 {id:'MGR-SHINY-001',name:'Mago Rojo Shiny',atk:8500,def:7000,type:'monster',family:'mago-rojo',tags:['fuego','mago-rojo','shiny','mitica','exclusiva'],rarity:'shiny-mitica',effect:'magoRojoShiny',strategicRedeem:true,shinyEdition:true,priceStars:1800,img:'assets/images/mago-rojo/mago-rojo-shiny.jpg',desc:'DOMINIO ESCARLATA SUPREMO: cada Mágica Mago Rojo genera 2 Sellos. 3 Sellos recuperan una Mágica; 5 Sellos infligen 2000 HP y dan +1000 ATK este turno; 7 Sellos infligen 3000 HP y bloquean efectos rivales este turno. MAESTRO DE LAS SIETE LLAMAS: con 3+ Sellos, tus monstruos Mago Rojo ganan +1000 ATK/+800 DEF. INFERNO ARCANO: una vez por turno destruye 1 carta rival e inflige 2000 HP por cada Sello Arcano controlado. PROTECCIÓN ESCARLATA: consume 3 Sellos para evitar su destrucción.'},
 {id:'limited-orbe-poder',name:'Orbe del Poder',atk:0,def:0,type:'magic',subtype:'weapon',family:'universal',tags:['universal','arma','borde-negro','limitada','poder'],rarity:'limitada-suprema',effect:'orbPowerWeapon',strategicRedeem:true,limitedBlackEdition:true,priceStars:3500,atkBonus:5000,defBonus:3000,img:'assets/images/strategic/orbe-del-poder.jpg',desc:'ARMA UNIVERSAL: equipa a 1 criatura. PODER ABSOLUTO: +5000 ATK/+3000 DEF. ABSORCIÓN DE ENERGÍA: una vez por turno, ante un efecto ofensivo rival, el portador gana +1000 ATK permanente. DESCARGA DEL ORBE: una vez por duelo destruye 1 carta rival y causa 2000 HP. NÚCLEO INDESTRUCTIBLE: evita la primera destrucción del Orbe por un efecto. DOMINIO DEL PODER: con 10000 ATK o más, el portador resiste reducciones de ATK por efectos rivales.'},
 {id:'MS-001',name:'Eclipse de NÉMESIS',atk:0,def:0,type:'magic',subtype:'spell',family:'universal',tags:['universal','magica','secreta-nemesis','eclipse','canje'],rarity:'secreta-nemesis',effect:'nemesisAbsoluteEclipse',strategicRedeem:true,shopExclusive:true,priceStars:5000,unnegatable:true,uncopyable:true,noOpponentSearch:true,img:'assets/images/strategic/eclipse-de-nemesis.svg',desc:'ECLIPSE ABSOLUTO — UNA VEZ POR DUELO. Elige 3: JUICIO DEL ECLIPSE destierra 1 carta rival ignorando protección normal; RENACIMIENTO SUPREMO revive 1 monstruo con sus efectos; SILENCIO DE NÉMESIS anula 1 habilidad, Mágica o Trampa rival y la sella ese turno; ASCENSIÓN ABSOLUTA concede +3500 ATK/+3500 DEF durante 2 turnos y protección de destrucción el primero; RUPTURA DEL DESTINO destruye 1 arma, armadura o reliquia rival e impide recuperarla durante el duelo. Solo 1 Eclipse de NÉMESIS puede resolverse por jugador y duelo.'}
];
...
CABALLEROS_SUBMUNDO_CARDS.forEach(c=>{if(!CARDS.some(x=>x.id===c.id))CARDS.push(c)});
...
window.NEMESIS_OWNER_EXCLUSIVE_CARD_IDS=Object.freeze([...NEMESIS_PRIVATE_CARD_IDS]);
function nemesisCardAllowedForUser(id){return !NEMESIS_PRIVATE_CARD_IDS.has(id)||nemesisOwnerSessionActive()}
window.NEMESIS_OWNER_CARD_AUDIT=()=>({
 authenticated:nemesisOwnerSessionActive(),
 total:NEMESIS_PRIVATE_CARD_IDS.size,
 available:[...NEMESIS_PRIVATE_CARD_IDS].filter(id=>nemesisCardAllowedForUser(id)&&state.owned.includes(id)&&!!card(id)),
 missing:[...NEMESIS_PRIVATE_CARD_IDS].filter(id=>!card(id)),
 blocked:[...NEMESIS_PRIVATE_CARD_IDS].filter(id=>!nemesisCardAllowedForUser(id))
});
...
window.NEMESIS_OWNER_CONTROL=Object.freeze({
 ...
 login:nemesisOwnerLogin,
 logout:nemesisOwnerLogout,
...
function nemesisCardArt(c){
 if(!c)return '';
 return window.nemesisRealCardArt?.(c.id,c.img||'')||c.img||'';
}
...
document.addEventListener('error',e=>{
 ...
 const id=img.dataset.cardId;if(!id)return;const c=card(id);if(!c)return;
 const candidates=window.nemesisCardArtCandidates?.(id,c.img||'')||[c.img||''];
 const tried=new Set((img.dataset.nemesisTried||'').split('|').filter(Boolean));tried.add(img.currentSrc||img.src);
 const next=candidates.find(src=>{try{return !tried.has(new URL(src,document.baseURI).href)&&!tried.has(src)}catch{return !tried.has(src)}});
 if(next){img.dataset.nemesisTried=[...tried].join('|');img.src=next}
},{capture:true});
...
function sanctuaryScene(){
 ...
 const cards=NEMESIS_UNIQUE_CARDS.map(u=>{
  ...
  return `<article class="unique-pedestal ${trial?'trial-open':''} ${owned?'claimed':''}">
   <div class="unique-aura"></div><img src="${u.img}" alt="${u.name}" loading="lazy" decoding="async" fetchpriority="low">
...
const NEMESIS_RETRY_ROSTER=Object.freeze([
 ...
 {id:'dragon-ojo',name:'Dragón Ojo del Diablo',role:'JEFE',flag:'dragonDefeated',reward:150,img:'assets/images/dragon-ojo-del-diablo.png',battleKey:'dragon'},
 {id:'ira-ra',name:'Ira de Ra',role:'JEFE',flag:'raDefeated',reward:200,img:'assets/images/ira-de-ra-jefe.png',battleKey:'ra'},
...
function nemesisCreateProfileScene(){
 ...
 const commit=()=>{const name=nemesisValidPlayerName(input.value);if(!name){err.textContent='Escribe un nombre para continuar.';input.focus();return}state.name=name;state.profileCreated=true;state.lastAutosaveAt=Date.now();menuScene();setTimeout(()=>{try{v18918SaveMemoryCard()}catch(e){console.warn('NÉMESIS perfil autosave',e)}},0)};
...
function collectionScene(){
 ...
 <div class="grid inventory-grid">${catalogCards.map(c=>{const access=nemesisCardAllowedForUser(c.id),owned=state.owned.includes(c.id)&&access,inDeck=state.deck.includes(c.id)&&access,treasure=c.treasure===true,ownerOnly=NEMESIS_PRIVATE_CARD_IDS.has(c.id);const status=!access&&ownerOnly?'SOLO PROPIETARIO':inDeck?'EN MAZO · TOCA PARA QUITAR':owned?'CANJEAR AL MAZO':treasure?'TESORO · ★1000 EN TESOROS':'BLOQUEADA';return `<button class="card ${inDeck?'sel':''} ${owned?'owned-card':'locked-card'}" ${owned?`data-id="${c.id}" data-owned="1"`:'disabled'}><img data-card-id="${c.id}" src="${nemesisCardArt(c)}" alt="${esc(c.name)}" loading="lazy" decoding="async" fetchpriority="low"><b>${c.name}</b><small>${cardStats(c)}</small><small>${status}</small></button>`}).join('')}${emptySlots}</div>
...
function story(name,text,buttons,bg,ch){app.innerHTML=`<section class="story" style="background-image:url('${bg}')"><img class="char" src="${ch}" decoding="async"><div class="dialog"><h2>${name}</h2><div>${text}</div><div class="choices">${buttons}</div></div></section>`}
...
window.__nemesisEclipseUsedP=false;window.__nemesisEclipseUsedE=false;window.__nemesisEclipseBanished=[];
...
function nemesisUnequip(side,i,kind,{broken=false,toGrave=true,reason=''}={}){
 ...
 const eq=slots[kind];
 if(broken&&eq.sourceEffect==='orbPowerWeapon'&&!eq.orbShieldUsed&&/^destruido por /i.test(String(reason||''))){eq.orbShieldUsed=true;toast('NÚCLEO INDESTRUCTIBLE: el Orbe evita su primera destrucción.');return false}
 ...
 if(kind==='relic'&&['CS-017','CS-018'].includes(eq.sourceId))csSubworldRelicCleanup(side,eq.sourceId);
...
function v171ShowAttackConfirm(i){
 ...
 x.querySelector('#v171attack').onclick=async()=>{
   ...
   try{
     ...
     if(nemesisDmKeepTurnAfterAttack(dmAttacker)||idrKeepTurnAfterAttack(dmAttacker)||csKeepTurnAfterAttack(dmAttacker)){setPhase('ACTION',`TU TURNO ${turnNo} · ATAQUE ADICIONAL`,{force:true});battleActions.classList.remove('hidden');return}
     await enemyTurn();
   }catch(err){
...
function nemesisBattleResolution(kind,title,detail=''){
 try{
  let style=document.getElementById('nemesis-battle-resolution-style');
  if(!style){
   style=document.createElement('style');style.id='nemesis-battle-resolution-style';
   style.textContent='.nemesis-battle-resolution{position:fixed;left:50%;top:19%;transform:translate(-50%,-50%) scale(.9);z-index:2147482000;min-width:min(620px,88vw);padding:14px 20px;border:1px solid rgba(255,255,255,.32);background:linear-gradient(180deg,rgba(8,9,18,.96),rgba(18,7,28,.92));box-shadow:0 0 38px rgba(167,80,255,.38),inset 0 0 22px rgba(255,255,255,.05);text-align:center;color:#fff;font-family:Arial,sans-serif;pointer-events:none;opacity:0;animation:nemesisBattleCue .78s ease forwards}.nemesis-battle-resolution small{display:block;font-size:11px;letter-spacing:.28em;color:#f5ca67}.nemesis-battle-resolution b{display:block;margin-top:5px;font-size:clamp(18px,2.2vw,30px);letter-spacing:.06em;text-shadow:0 0 16px rgba(255,255,255,.28)}.nemesis-battle-resolution span{display:block;margin-top:4px;font-size:12px;letter-spacing:.11em;color:#d8d3e8}.nemesis-battle-resolution.defensa{box-shadow:0 0 42px rgba(90,180,255,.42),inset 0 0 22px rgba(120,200,255,.08)}.nemesis-battle-resolution.destruccion{box-shadow:0 0 44px rgba(255,70,70,.42),inset 0 0 22px rgba(255,80,80,.08)}@keyframes nemesisBattleCue{0%{opacity:0;transform:translate(-50%,-50%) scale(.82)}16%{opacity:1;transform:translate(-50%,-50%) scale(1.04)}72%{opacity:1;transform:translate(-50%,-50%) scale(1)}100%{opacity:0;transform:translate(-50%,-56%) scale(.98)}}';
   document.head.appendChild(style);
  }
  document.querySelectorAll('.nemesis-battle-resolution').forEach(x=>x.remove());
  const d=document.createElement('div');d.className='nemesis-battle-resolution '+String(kind||'').toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g,'');
  d.innerHTML=`<small>${esc(String(kind||'BATALLA'))}</small><b>${esc(String(title||'NÉMESIS'))}</b><span>${esc(String(detail||''))}</span>`;
  document.body.appendChild(d);setTimeout(()=>d.remove(),900);
 }catch(e){console.warn('[NÉMESIS batalla visual]',e)}
}
...
async function extResurrect(side,n=1){
 ...
 while(done<n){
   ...
   if(free<0||!gi)break;
   const rev={...gi.c};grave.splice(gi.i,1);arr[free]=rev;csHorusBlessResurrection(side,rev);modes[free]='ATAQUE';await place(side,free,rev);await flip(side,free);await setMode(side,free,'ATAQUE');done++;
 }
 return done>0
}
...
function strategicDeathGolemSoul(c){if(!c||c.effect!=='strategicDeathGolem'||(c._deathGolemSoulAtk||0)>=3000)return;const gain=Math.min(500,3000-(c._deathGolemSoulAtk||0));c.atk+=gain;c._deathGolemSoulAtk=(c._deathGolemSoulAtk||0)+gain;if(c._deathGolemSoulAtk>=3000&&!c._deathGolemSentenceReadyTurn)c._deathGolemSentenceReadyTurn=turnNo+1}
function strategicOnMonsterToGrave(){[...playerCards,...enemyCards].forEach(strategicDeathGolemSoul)}
async function strategicDeathGolemUse(side,i,c){if((c._deathGolemSoulAtk||0)<3000||turnNo<(c._deathGolemSentenceReadyTurn||Infinity)||c._deathGolemSentenceUsed){toast('SENTENCIA MORTAL aún no está disponible.');return false}const riv=side==='p'?enemyCards:playerCards,rs=side==='p'?'e':'p',valid=riv.map((x,j)=>({c:x,i:j})).filter(x=>x.c&&(x.c.atk||0)<(c.atk||0));if(!valid.length){toast('No hay monstruos rivales con ATK inferior.');return false}const t=side==='p'?await chooseMagicTarget('SENTENCIA MORTAL · ELIGE OBJETIVO',valid,rs):valid.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!t)return false;c._deathGolemSentenceUsed=true;await destroyCard(rs,t.i);strategicOnMonsterToGrave();toast('SENTENCIA MORTAL destruye a '+t.c.name+'.');return true}
async function strategicVoidMageUse(side,i,c){const riv=side==='p'?enemyCards:playerCards,rs=side==='p'?'e':'p',valid=riv.map((x,j)=>({c:x,i:j})).filter(x=>x.c);if(valid.length){const t=side==='p'?await chooseMagicTarget('DISTORSIÓN DEL VACÍO · ELIGE OBJETIVO',valid,rs):valid.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(t){t.c._strategicSkillNegatedUntil=turnNo+1;toast('DISTORSIÓN DEL VACÍO anula la habilidad de '+t.c.name+'.');return true}}if(c._voidPortalUsed)return false;const all=[...playerGrave.map(x=>({c:x,side:'p'})),...enemyGrave.map(x=>({c:x,side:'e'}))].filter(x=>x.c&&x.c.type==='monster');if(!all.length)return false;const t=side==='p'?await chooseMagicTarget('PORTAL DEL VACÍO · ELIGE MONSTRUO',all,'p'):all.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!t)return false;const gr=t.side==='p'?playerGrave:enemyGrave,q=t.side==='p'?handState:enemyQueue,idx=gr.indexOf(t.c);if(idx<0)return false;gr.splice(idx,1);q.push(t.side==='p'?t.c.id:{...t.c});c._voidPortalUsed=true;if(t.side==='p')renderHand();toast('PORTAL DEL VACÍO devuelve '+t.c.name+' a la mano.');return true}
function strategicVoidMageOnMagic(side){const own=side==='p'?enemyCards:playerCards;own.filter(c=>c?.effect==='strategicVoidMage').forEach(c=>{if(c._voidAbsorbMagicTurn===turnNo)return;c._voidAbsorbMagicTurn=turnNo;c.atk+=500;c.def+=500;c._voidAbsorbExpires=turnNo+1;toast('ABSORCIÓN ARCANA: '+c.name+' obtiene +500 ATK / +500 DEF.')})}
function strategicVoidMageExpire(){for(const arr of [playerCards,enemyCards])arr.forEach(c=>{if(c?._voidAbsorbExpires!=null&&turnNo>c._voidAbsorbExpires){c.atk=Math.max(0,c.atk-500);c.def=Math.max(0,c.def-500);delete c._voidAbsorbExpires}})}


function strategicPrometheusEnter(c){if(c?.effect==='strategicPrometheus'&&c._prometheusEnterTurn==null)c._prometheusEnterTurn=turnNo}
function strategicPrometheusPreventDestroy(c){if(c?.effect!=='strategicPrometheus'||c._prometheusSaved)return false;c._prometheusSaved=true;toast('TITÁN ENCADENADO: Prometeo evita su primera destrucción.');return true}
async function strategicPrometheusUse(side,i,c){
 strategicPrometheusEnter(c);const rivals=side==='p'?enemyCards:playerCards,rs=side==='p'?'e':'p',opts=rivals.map((x,j)=>({c:x,i:j})).filter(x=>x.c);
 if(!c._prometheusFinalUsed&&turnNo-(c._prometheusEnterTurn??turnNo)>=3&&opts.length){
  const t=side==='p'?await chooseMagicTarget('LLAMA PRIMORDIAL · ELIGE OBJETIVO',opts,rs):opts.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];
  if(t){c._prometheusFinalUsed=true;await destroyCard(rs,t.i);if(side==='p')ehpv=Math.max(0,ehpv-1500);else phpv=Math.max(0,phpv-1500);damageFx(1500,rs);toast('LLAMA PRIMORDIAL: objetivo destruido · 1500 HP de daño directo.');return true}
 }
 if(c._prometheusFireTurn!==turnNo&&opts.length){
  const t=side==='p'?await chooseMagicTarget('FUEGO DE LOS DIOSES · ELIGE OBJETIVO',opts,rs):opts.sort((a,b)=>(b.c.def||0)-(a.c.def||0))[0];
  if(t){c._prometheusFireTurn=turnNo;const loss=Math.min(2000,Math.max(0,t.c.def||0));t.c.def=Math.max(0,(t.c.def||0)-2000);t.c._prometheusDefLoss=(t.c._prometheusDefLoss||0)+loss;t.c._prometheusDefUntil=turnNo;toast('FUEGO DE LOS DIOSES: '+t.c.name+' pierde 2000 DEF este turno.');return true}
 }
 if(!c._prometheusGiftUsed){c._prometheusGiftUsed=true;c.atk+=2000;c.def+=2000;c._prometheusGiftBonus=2000;c._prometheusGiftUntil=turnNo+1;toast('REGALO PROHIBIDO: Prometeo obtiene +2000 ATK/+2000 DEF durante 2 turnos.');return true}
 return false
}
function strategicPrometheusExpire(){for(const arr of [playerCards,enemyCards])arr.forEach(c=>{if(!c)return;strategicPrometheusEnter(c);if(c._prometheusDefUntil!=null&&turnNo>c._prometheusDefUntil){c.def+=c._prometheusDefLoss||0;delete c._prometheusDefLoss;delete c._prometheusDefUntil}if(c._prometheusGiftBonus&&turnNo>c._prometheusGiftUntil){c.atk=Math.max(0,c.atk-c._prometheusGiftBonus);c.def=Math.max(0,c.def-c._prometheusGiftBonus);delete c._prometheusGiftBonus;delete c._prometheusGiftUntil}})}

function eternalVoidGodEnter(c){if(c?.effect==='eternalVoidGod'&&c._evgEnterTurn==null)c._evgEnterTurn=turnNo}
function eternalVoidGodPreventDestroy(c){if(c?.effect!=='eternalVoidGod'||c._evgSaved)return false;c._evgSaved=true;c.atk=7500;c.def=6500;toast('EXISTENCIA ETERNA: evita su primera destrucción y queda 7500/6500.');return true}
function eternalVoidGodDomain(side){const gods=(side==='p'?enemyCards:playerCards).filter(c=>c?.effect==='eternalVoidGod');for(const god of gods){if(god._evgDomainTurn===turnNo)continue;const target=(side==='p'?playerCards:enemyCards).filter(Boolean).sort((a,b)=>(b.atk||0)-(a.atk||0))[0];if(!target)continue;god._evgDomainTurn=turnNo;target.atk=Math.max(0,target.atk-3000);target.def=Math.max(0,target.def-3000);target._evgDomainRestore=(target._evgDomainRestore||0)+3000;target._evgDomainUntil=turnNo;target._attackDisabledUntil=Math.max(target._attackDisabledUntil||0,turnNo);toast('DOMINIO DEL VACÍO debilita a '+target.name+'.')}}
async function eternalVoidGodUse(side,i,c){eternalVoidGodEnter(c);const rivals=side==='p'?enemyCards:playerCards,rs=side==='p'?'e':'p';const drain=rivals.map((x,j)=>({c:x,i:j})).filter(x=>x.c&&(x.c.atk||0)>8000);if(c._evgDrainTurn!==turnNo&&drain.length){const t=side==='p'?await chooseMagicTarget('DEVORADOR DE PODER',drain,rs):drain.sort((a,b)=>b.c.atk-a.c.atk)[0];if(t){c._evgDrainTurn=turnNo;t.c.atk-=2000;t.c._evgDrainLoss=(t.c._evgDrainLoss||0)+2000;t.c._evgDrainUntil=turnNo;c.atk+=2000;c._evgDrainGain=(c._evgDrainGain||0)+2000;c._evgDrainOwnUntil=turnNo;toast('DEVORADOR DE PODER absorbe 2000 ATK.');return true}}if(!c._evgCollapseUsed){const opts=rivals.filter(Boolean).sort((a,b)=>(b.atk||0)-(a.atk||0)).slice(0,2);if(opts.length){opts.forEach(x=>x._strategicSkillNegatedUntil=turnNo+1);c._evgCollapseUsed=true;toast('COLAPSO DIMENSIONAL anula hasta 2 habilidades rivales.');return true}}if(!c._evgFinalUsed&&turnNo-(c._evgEnterTurn||turnNo)>=3){const opts=rivals.map((x,j)=>({c:x,i:j})).filter(x=>x.c);if(opts.length){const t=side==='p'?await chooseMagicTarget('FIN DEL UNIVERSO',opts,rs):opts.sort((a,b)=>b.c.atk-a.c.atk)[0];if(t){c._evgFinalUsed=true;c._attackDisabledUntil=turnNo;await destroyCard(rs,t.i);if(side==='p')ehpv=Math.max(0,ehpv-2000);else phpv=Math.max(0,phpv-2000);damageFx(2000,rs);toast('FIN DEL UNIVERSO: 2000 HP de daño directo.');return true}}}return false}
function eternalVoidGodExpire(){for(const arr of [playerCards,enemyCards])arr.forEach(c=>{eternalVoidGodEnter(c);if(c?._evgDomainUntil!=null&&turnNo>c._evgDomainUntil){c.atk+=c._evgDomainRestore||0;c.def+=c._evgDomainRestore||0;delete c._evgDomainRestore;delete c._evgDomainUntil}if(c?._evgDrainUntil!=null&&turnNo>c._evgDrainUntil){c.atk+=c._evgDrainLoss||0;delete c._evgDrainLoss;delete c._evgDrainUntil}if(c?._evgDrainOwnUntil!=null&&turnNo>c._evgDrainOwnUntil){c.atk=Math.max(0,c.atk-(c._evgDrainGain||0));delete c._evgDrainGain;delete c._evgDrainOwnUntil}})}
function orbPowerEquipment(c){const s=nemesisEquipmentSlots(c);return s?.weapon?.sourceEffect==='orbPowerWeapon'?s.weapon:null}
function orbPowerDominion(c){return !!c&&!!orbPowerEquipment(c)&&(c.atk||0)>=10000}
function orbPowerAbsorbOnOffense(side,sk){
 const targetSide=side==='p'?'e':'p',arr=targetSide==='p'?playerCards:enemyCards;
 const offensive=!['heal','shield','solarShield','attack'].includes(sk?.kind);
 if(!offensive)return false;
 const bearer=arr.find(c=>c&&orbPowerEquipment(c));if(!bearer)return false;
 const eq=orbPowerEquipment(bearer);if(eq.orbAbsorbTurn===turnNo)return false;
 eq.orbAbsorbTurn=turnNo;bearer.atk=(bearer.atk||0)+1000;eq.orbAbsorbTotal=(eq.orbAbsorbTotal||0)+1000;
 toast('ABSORCIÓN DE ENERGÍA: '+bearer.name+' gana +1000 ATK permanente.');return true
}
async function orbPowerEquip(side,c){
 const own=side==='p'?playerCards:enemyCards,choices=own.map((x,i)=>({c:x,i})).filter(x=>x.c&&x.c.type!=='magic'&&x.c.type!=='trap');
 if(!choices.length){toast('ORBE DEL PODER: no hay criatura válida para equipar.');return false}
 const pick=side==='p'?await chooseMagicTarget('ORBE DEL PODER · ELIGE PORTADOR',choices,side):choices.sort((a,b)=>((b.c.atk||0)+(b.c.def||0))-((a.c.atk||0)+(a.c.def||0)))[0];
 if(!pick)return false;
 nemesisEquip(side,pick.i,'weapon',c,{atkBonus:5000,defBonus:3000,flag:'_orbPower'});
 const target=own[pick.i],eq=orbPowerEquipment(target);if(eq){eq.orbShieldUsed=false;eq.orbDischargeUsed=false;eq.orbAbsorbTurn=-1;eq.orbAbsorbTotal=0}
 toast('ORBE DEL PODER equipado: +5000 ATK / +3000 DEF.');return true
}
async function orbPowerDischarge(side,i,c){
 const eq=orbPowerEquipment(c);if(!eq||eq.orbDischargeUsed)return false;
 const rivals=side==='p'?enemyCards:playerCards,rs=side==='p'?'e':'p',opts=rivals.map((x,j)=>({c:x,i:j})).filter(x=>x.c);
 if(!opts.length)return false;
 const pick=side==='p'?await chooseMagicTarget('DESCARGA DEL ORBE · ELIGE CARTA RIVAL',opts,rs):opts.sort((a,b)=>((b.c.atk||0)+(b.c.def||0))-((a.c.atk||0)+(a.c.def||0)))[0];
 if(!pick)return false;
 eq.orbDischargeUsed=true;await destroyCard(rs,pick.i);
 if(side==='p')ehpv=Math.max(0,ehpv-2000);else phpv=Math.max(0,phpv-2000);
 damageFx(2000,rs);toast('DESCARGA DEL ORBE: carta destruida · 2000 HP de daño directo.');update();return true
}
...
// CABALLEROS DEL SUBMUNDO · reutiliza Cementerio, destrucción, turnos y colección existentes.
function csIs(c,id=null){return !!c&&c.family==='caballeros-submundo'&&(!id||c.id===id)}
function csOwn(side){return side==='p'?playerCards:enemyCards}
function csGrave(side){return side==='p'?playerGrave:enemyGrave}
...
function csSync(){
 for(const side of ['p','e']){
  ...
  const venuz=csOwn(side).find(x=>csIs(x,'CS-006'));if(venuz){const seen=venuz._csVenuzAbsorbedFallen||0;if(graveNow>seen){const d=graveNow-seen;venuz.atk+=1200*d;venuz.def+=800*d;venuz._csVenuzAbsorbedFallen=graveNow;toast('SOMBRA ABSOLUTA DE VENUZ: +'+(1200*d)+' ATK / +'+(800*d)+' DEF permanentes.')}}
  const venuzShiny=csOwn(side).find(x=>csIs(x,'CS-007'));if(venuzShiny){const seen=venuzShiny._csVenuzShinyAbsorbedFallen||0;if(graveNow>seen){const d=graveNow-seen;venuzShiny.atk+=1500*d;venuzShiny.def+=1000*d;venuzShiny._csVenuzShinyAbsorbedFallen=graveNow;toast('SOMBRA ABSOLUTA SHINY: +'+(1500*d)+' ATK / +'+(1000*d)+' DEF permanentes.')}if((venuzShiny._csShinyEclipseUntil||-1)>=turnNo){if(venuzShiny._csShinyFloorAtk!=null)venuzShiny.atk=Math.max(venuzShiny.atk||0,venuzShiny._csShinyFloorAtk);if(venuzShiny._csShinyFloorDef!=null)venuzShiny.def=Math.max(venuzShiny.def||0,venuzShiny._csShinyFloorDef)}}
  const roseCard=csOwn(side).find(x=>csIs(x,'CS-005'));if(roseCard&&graveNow>(roseCard._csRoseGraveSeen||0)&&roseCard._csRoseFuneralTurn!==turnNo&&(roseCard._csFuneralRoses||0)<5){roseCard._csRoseFuneralTurn=turnNo;roseCard._csFuneralRoses=(roseCard._csFuneralRoses||0)+1;roseCard.atk+=500;roseCard.def+=500;toast('ROSA DEL CABALLERO CAÍDO: Rose obtiene +500 ATK/+500 DEF permanente.')}if(roseCard)roseCard._csRoseGraveSeen=graveNow;
  const fallen=csGrave(side).filter(x=>csIs(x)).length;
  csOwn(side).forEach(c=>{
   if(!csIs(c,'CS-001')&&!csIs(c,'CS-002')&&!csIs(c,'CS-003')&&!csIs(c,'CS-004'))return;
...
function csWeaponEq(c){return nemesisEquipmentSlots(c)?.weapon||null}
async function csSubworldWeaponMagic(side,w){
 if(!w||w.family!=='caballeros-submundo'||w.subtype!=='weapon')return false;
 const arr=side==='p'?playerCards:enemyCards;
 const i=side==='p'?await magicAllyIndex(side,`ELIGE PORTADOR PARA ${w.name}`):arr.map((c,i)=>({c,i})).filter(x=>x.c&&x.c.family==='caballeros-submundo').sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0]?.i??-1;
 if(i<0||!arr[i]||arr[i].family!=='caballeros-submundo'){toast(`${w.name}: requiere un Caballero o Monstruo del Submundo.`);return false}
 const t=arr[i];
 nemesisEquip(side,i,'weapon',w,{atkBonus:Number(w.equipAtk||0),defBonus:Number(w.equipDef||0),flag:`_${w.effect}`});
 const eq=csWeaponEq(t);
 if(eq?.sourceId==='CS-012'&&['CS-006','CS-007'].includes(t.id)){t.atk+=1500;t.def+=1500;eq.venuzAtk=1500;eq.venuzDef=1500}
 if(eq?.sourceId==='CS-013'){eq.poisonTurns=3}
 toast(`${w.name} equipada a ${t.name} en ranura ARMA.`);update();return true
}
function csWeaponSkillDescriptor(c){
 const eq=csWeaponEq(c);if(!eq||eq.ultimateUsed)return null;
 if(eq.sourceId==='CS-011')return{name:'JUICIO DE ARES',kind:'caballerosSubmundo',action:'weaponAresUltimate',desc:'+5000 ATK temporal, Perforación Total y 2000 HP directo al destruir.'};
 if(eq.sourceId==='CS-012')return{name:'VEREDICTO DEL ECLIPSE',kind:'caballerosSubmundo',action:'weaponVenuzUltimate',desc:'+5000 ATK, Perforación y 2500 HP directo al ejecutar.'};
 if(eq.sourceId==='CS-013')return{name:'PICADURA DE LA MUERTE',kind:'caballerosSubmundo',action:'weaponScorpionUltimate',desc:'+4000 ATK, Perforación y Veneno máximo.'};
 if(eq.sourceId==='CS-014')return{name:'SINGULARIDAD ABSOLUTA',kind:'caballerosSubmundo',action:'weaponBlackHoleUltimate',desc:'+5000 ATK/+3000 DEF, Perforación y colapso del ejército rival.'};
 return null
}
function csSubworldWeaponUltimate(side,c,action){
 const eq=csWeaponEq(c);if(!eq||eq.ultimateUsed)return false;
 const map={weaponAresUltimate:'CS-011',weaponVenuzUltimate:'CS-012',weaponScorpionUltimate:'CS-013',weaponBlackHoleUltimate:'CS-014'};
 if(map[action]!==eq.sourceId)return false;
 eq.ultimateUsed=true;eq.ultimateUntil=turnNo;
 if(eq.sourceId==='CS-011'){c.atk+=5000;eq.ultimateAtk=5000;c._csWeaponPierceUntil=turnNo;c._csWeaponKillDirect=2000}
 if(eq.sourceId==='CS-012'){c.atk+=5000;eq.ultimateAtk=5000;c._csWeaponPierceUntil=turnNo;c._csWeaponKillDirect=2500}
 if(eq.sourceId==='CS-013'){c.atk+=4000;eq.ultimateAtk=4000;c._csWeaponPierceUntil=turnNo;c._csScorpionUltimate=true}
 if(eq.sourceId==='CS-014'){c.atk+=5000;c.def+=3000;eq.ultimateAtk=5000;eq.ultimateDef=3000;c._csWeaponPierceUntil=turnNo;
   const riv=side==='p'?enemyCards:playerCards;for(const x of riv)if(x){const al=Math.min(2000,x.atk||0),dl=Math.min(2000,x.def||0);x.atk-=al;x.def-=dl;x._csBlackHoleUltAtkLoss=(x._csBlackHoleUltAtkLoss||0)+al;x._csBlackHoleUltDefLoss=(x._csBlackHoleUltDefLoss||0)+dl}
 }
 toast(c.name+' activa '+(action==='weaponAresUltimate'?'JUICIO DE ARES':action==='weaponVenuzUltimate'?'VEREDICTO DEL ECLIPSE':action==='weaponScorpionUltimate'?'PICADURA DE LA MUERTE':'SINGULARIDAD ABSOLUTA')+'.');update();return true
}
function csSubworldWeaponBeforeCombat(side,c,target){
 const eq=csWeaponEq(c);if(!eq||!target)return;
 if(eq.sourceId==='CS-011'){
  if(target.def>(c._csBaseAtk||((c.atk||0)-(eq.atkBonus||0)))&&eq.aresVsWallTurn!==turnNo){eq.aresVsWallTurn=turnNo;c.atk+=2000;c._csAresWallBonus=(c._csAresWallBonus||0)+2000}
  if(eq.ruptureTurn!==turnNo){eq.ruptureTurn=turnNo;const n=Math.min(2500,target.def||0);target.def-=n;target._csAresRuptureLoss=(target._csAresRuptureLoss||0)+n}
 }
 if(eq.sourceId==='CS-012'&&eq.sentenceTurn!==turnNo){
  eq.sentenceTurn=turnNo;const n=Math.min(2000,target.def||0);target.def-=n;target._csVenuzSentenceLoss=(target._csVenuzSentenceLoss||0)+n;target._csVenuzMarkedUntil=turnNo+2
 }
 if(eq.sourceId==='CS-013'){
  target._csPoisonStacks=Math.min(3,(target._csPoisonStacks||0)+1);target._csPoisonUntil=Math.max(target._csPoisonUntil||0,turnNo+3);
  if(target._csPoisonStacks===1){const a=Math.min(1000,target.atk||0),d=Math.min(1000,target.def||0);target.atk-=a;target.def-=d;target._csPoisonAtkLoss=(target._csPoisonAtkLoss||0)+a;target._csPoisonDefLoss=(target._csPoisonDefLoss||0)+d}
  if(target._csPoisonStacks===2&&!target._csPoisonBurstTurn){target._csPoisonBurstTurn=turnNo;if(side==='p'){ehpv=Math.max(0,ehpv-1000);damageFx(1000,'e')}else{phpv=Math.max(0,phpv-1000);damageFx(1000,'p')}}
  if(c._csScorpionUltimate){target._csPoisonStacks=3}
 }
 if(eq.sourceId==='CS-014'&&eq.gravityTurn!==turnNo){
  eq.gravityTurn=turnNo;const a=Math.floor((target.atk||0)*.30),d=Math.floor((target.def||0)*.30);target.atk=Math.max(0,target.atk-a);target.def=Math.max(0,target.def-d);target._csGravityAtkLoss=(target._csGravityAtkLoss||0)+a;target._csGravityDefLoss=(target._csGravityDefLoss||0)+d
 }
}
function csSubworldWeaponAfterKill(side,c){
 const eq=csWeaponEq(c);if(!eq)return;
 if(eq.sourceId==='CS-011'){const gain=Math.min(1000,3000-(eq.battleAtk||0));if(gain>0){c.atk+=gain;eq.battleAtk=(eq.battleAtk||0)+gain}}
 if(eq.sourceId==='CS-014'){const gain=Math.min(500,3000-(eq.devourAtk||0));if(gain>0){c.atk+=gain;c.def+=gain;eq.devourAtk=(eq.devourAtk||0)+gain;eq.devourDef=(eq.devourDef||0)+gain}}
 if(c._csWeaponKillDirect){const n=c._csWeaponKillDirect;if(side==='p'){ehpv=Math.max(0,ehpv-n);damageFx(n,'e')}else{phpv=Math.max(0,phpv-n);damageFx(n,'p')};delete c._csWeaponKillDirect}
}
function csSubworldWeaponAfterSurvive(side,c,attacker){
 const eq=csWeaponEq(c);if(!eq)return;
 if(eq.sourceId==='CS-011')c._csAresCounterPierce=true;
 if(eq.sourceId==='CS-013'&&attacker){attacker._csPoisonStacks=Math.min(3,(attacker._csPoisonStacks||0)+1);attacker._csPoisonUntil=Math.max(attacker._csPoisonUntil||0,turnNo+3)}
}
function csSubworldWeaponPiercing(c){const eq=csWeaponEq(c);return !!(eq&&(c._csAresCounterPierce||c._csWeaponPierceUntil===turnNo||eq.sourceId==='CS-014'&&eq.ultimateUntil===turnNo))}
function csSubworldWeaponPreventDestroy(side,i,victim,cause='effect'){
 const eq=csWeaponEq(victim);if(!eq)return false;
 if(eq.sourceId==='CS-012'&&!eq.savedDuel){eq.savedDuel=true;nemesisUnequip(side,i,'weapon',{broken:true,toGrave:true,reason:'VOLUNTAD DE VENUZ sustituye la destrucción'});toast('VOLUNTAD DE VENUZ: el arma se destruye en lugar del portador.');return true}
 if(eq.sourceId==='CS-011'&&['CS-003','CS-007'].includes(victim.id)&&cause!=='combat'&&!eq.shinySaveUsed){eq.shinySaveUsed=true;nemesisUnequip(side,i,'weapon',{broken:true,toGrave:true,reason:'SINERGIA DEL SUBMUNDO sustituye la destrucción'});toast('SINERGIA DEL SUBMUNDO: Luz de Ares salva la versión Shiny.');return true}
 return false
}
function csSubworldWeaponClearTurn(){
 for(const arr of [playerCards,enemyCards])arr.forEach(c=>{if(!c)return;
  for(const [k,field] of [['_csAresRuptureLoss','def'],['_csVenuzSentenceLoss','def'],['_csGravityAtkLoss','atk'],['_csGravityDefLoss','def'],['_csBlackHoleUltAtkLoss','atk'],['_csBlackHoleUltDefLoss','def']])if(c[k]){c[field]+=c[k];delete c[k]}
  if(c._csAresWallBonus){c.atk=Math.max(0,c.atk-c._csAresWallBonus);delete c._csAresWallBonus}
  delete c._csAresCounterPierce;
  const eq=csWeaponEq(c);if(eq&&eq.ultimateUntil!=null&&turnNo>eq.ultimateUntil){if(eq.ultimateAtk){c.atk=Math.max(0,c.atk-eq.ultimateAtk);delete eq.ultimateAtk}if(eq.ultimateDef){c.def=Math.max(0,c.def-eq.ultimateDef);delete eq.ultimateDef}delete c._csWeaponPierceUntil;delete c._csScorpionUltimate}
  if(c._csPoisonUntil!=null&&turnNo>c._csPoisonUntil){if(c._csPoisonAtkLoss){c.atk+=c._csPoisonAtkLoss;delete c._csPoisonAtkLoss}if(c._csPoisonDefLoss){c.def+=c._csPoisonDefLoss;delete c._csPoisonDefLoss}delete c._csPoisonStacks;delete c._csPoisonUntil;delete c._csPoisonBurstTurn}
 })
}
function csArmorSkillDescriptor(c){
 const weapon=csWeaponSkillDescriptor(c);if(weapon)return weapon;
 const relic=csRelicSkillDescriptor(c);if(relic)return relic;
...
async function csUseSkill(side,i,c,sk){
 if(['weaponAresUltimate','weaponVenuzUltimate','weaponScorpionUltimate','weaponBlackHoleUltimate'].includes(sk.action))return csSubworldWeaponUltimate(side,c,sk.action);
 if(sk.action==='tartarusGates'||sk.action==='underworldJudgement')return await csSubworldRelicUltimate(side,c,sk.action);
...
async function csPreventDestroy(side,i,victim,cause='effect'){
 if(csSubworldWeaponPreventDestroy(side,i,victim,cause))return true;
 ...
 if(csIs(victim,'CS-007')){
  ...
  if(!victim._csShinyRenacerUsedDuel){
   victim._csShinyRenacerUsedDuel=true;victim.atk+=4000;victim.def+=4000;
   const own=csOwn(side),modes=side==='p'?playerModes:enemyModes,free=[];for(let j=0;j<own.length;j++)if(!own[j])free.push(j);const revived=[];
   for(let n=0;n<2&&free.length;n++){const gi=grave.findIndex(x=>csIs(x));if(gi<0)break;const rc=grave.splice(gi,1)[0],slot=free.shift();own[slot]=rc;modes[slot]='ATAQUE';csHorusBlessResurrection(side,rc);try{await place(side,slot,rc);await flip(side,slot);await setMode(side,slot,'ATAQUE')}catch(e){console.warn('cs shiny revive visual',e)}revived.push(rc.name)}
   csSync();toast('RENACER DEL VACÍO: destrucción evitada · +4000 ATK/+4000 DEF permanentes'+(revived.length?' · resucita '+revived.join(' y '):'')+'.');return true
  }
 }

 if(csIs(victim,'CS-006')&&!victim._csVenuzReturnUsedDuel){victim._csVenuzReturnUsedDuel=true;victim.atk+=3000;victim.def+=3000;const own=csOwn(side),slot=own.findIndex(x=>!x),gi=grave.findIndex(x=>csIs(x));if(slot>=0&&gi>=0){const rc=grave.splice(gi,1)[0];own[slot]=rc;csHorusBlessResurrection(side,rc)}csSync();toast('RETORNO DEL SOBERANO: destrucción evitada · +3000 ATK/+3000 DEF · resurrección.');return true}
...
async function csVenuzShinyUseSkill(side,c){
 if(c._csVenuzShinySkillTurn===turnNo){toast('ECLIPSE SUPREMO ya fue usado este turno.');return false}
 const rivals=csOwn(side==='p'?'e':'p').map((x,i)=>({c:x,i})).filter(x=>x.c);if(!rivals.length)return false;
 const fallen=csGrave(side).filter(x=>csIs(x)).length;
 if(!c._csVenuzShinyFinalUsedDuel&&fallen>=5){
  const activate=side==='p'?confirm('ECLIPSE DE LA ETERNIDAD: ¿activarlo durante 2 turnos?'):true;
  if(activate){c._csVenuzShinyFinalUsedDuel=true;c._csShinyEclipseUntil=turnNo+1;c.atk+=6000;c.def+=4000;c._csVenuzShinyFinalAtk=6000;c._csVenuzShinyFinalDef=4000;c._csShinyFloorAtk=Math.ceil(c.atk*.7);c._csShinyFloorDef=Math.ceil(c.def*.7);c._csVenuzShinySkillTurn=turnNo;toast('ECLIPSE DE LA ETERNIDAD: +6000 ATK/+4000 DEF · PERFORACIÓN · piso 70% durante 2 turnos.');return true}
 }
 const pick=side==='p'?await chooseMagicTarget('ECLIPSE SUPREMO · ELIGE OBJETIVO',rivals,side):rivals.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!pick)return false;
 const t=pick.c,lossA=Math.floor((t.atk||0)*.5),lossD=Math.floor((t.def||0)*.5);t.atk=Math.max(0,t.atk-lossA);t.def=Math.max(0,t.def-lossD);t._csVenuzEclipseAtk=(t._csVenuzEclipseAtk||0)+lossA;t._csVenuzEclipseDef=(t._csVenuzEclipseDef||0)+lossD;t._csVenuzEclipseUntil=turnNo;
 c.atk+=2500;c._csVenuzShinyTempAtk=(c._csVenuzShinyTempAtk||0)+2500;c._csVenuzShinyTempUntil=turnNo;c._csShinyEclipseUntil=Math.max(c._csShinyEclipseUntil||-1,turnNo);c._csShinyFloorAtk=Math.ceil(c.atk*.7);c._csShinyFloorDef=Math.ceil(c.def*.7);c._csVenuzShinySkillTurn=turnNo;
 toast('ECLIPSE SUPREMO: '+t.name+' pierde 50% ATK/DEF · Venuz Shiny +2500 ATK.');update();return true
}
function csVenuzShinyPiercingDamage(side,c,target){if(!csIs(c,'CS-007')||(c._csShinyEclipseUntil||-1)<turnNo||!target)return 0;return Math.max(0,(c.atk||0)-(target.def||0))}
async function csVenuzUseSkill(side,c){if(c._csVenuzSkillTurn===turnNo){toast('ECLIPSE DEL SUBMUNDO ya fue usado este turno.');return false}const rivals=csOwn(side==='p'?'e':'p').map((x,i)=>({c:x,i})).filter(x=>x.c);if(!rivals.length)return false;const fallen=csGrave(side).filter(x=>csIs(x)).length;if(!c._csVenuzFinalUsedDuel&&fallen>=5){const activate=side==='p'?confirm('ECLIPSE FINAL — TRONO DE VENUZ: ¿activarlo durante 2 turnos?'):true;if(activate){c._csVenuzFinalUsedDuel=true;c._csVenuzFinalUntil=turnNo+1;c.atk+=5000;c.def+=3000;c._csVenuzFinalAtk=5000;c._csVenuzFinalDef=3000;c._csVenuzSkillTurn=turnNo;toast('ECLIPSE FINAL: +5000 ATK/+3000 DEF y PERFORACIÓN durante 2 turnos.');return true}}const pick=side==='p'?await chooseMagicTarget('ECLIPSE DEL SUBMUNDO · ELIGE OBJETIVO',rivals,side):rivals.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!pick)return false;const t=pick.c,lossA=Math.floor((t.atk||0)*.5),lossD=Math.floor((t.def||0)*.5);t.atk=Math.max(0,t.atk-lossA);t.def=Math.max(0,t.def-lossD);t._csVenuzEclipseAtk=(t._csVenuzEclipseAtk||0)+lossA;t._csVenuzEclipseDef=(t._csVenuzEclipseDef||0)+lossD;t._csVenuzEclipseUntil=turnNo;c.atk+=2000;c._csVenuzTempAtk=(c._csVenuzTempAtk||0)+2000;c._csVenuzTempUntil=turnNo;c._csVenuzSkillTurn=turnNo;toast('ECLIPSE DEL SUBMUNDO: '+t.name+' pierde 50% ATK/DEF · Venuz +2000 ATK.');update();return true}
function csVenuzPiercingDamage(side,c,target){if(!csIs(c,'CS-006')||(c._csVenuzFinalUntil||-1)<turnNo||!target)return 0;return Math.max(0,(c.atk||0)-(target.def||0))}
function csRoseApplyMark(target,n=1){if(!target)return;const old=target._csRoseMarks||0,next=Math.min(3,old+n),d=next-old;if(d<=0)return;target._csRoseMarks=next;target.atk=Math.max(0,(target.atk||0)-700*d);target.def=Math.max(0,(target.def||0)-500*d);target._csRoseAtkLoss=(target._csRoseAtkLoss||0)+700*d;target._csRoseDefLoss=(target._csRoseDefLoss||0)+500*d}
function csRoseOnSummon(side,c){if(!csIs(c,'CS-005')||c._csRoseEntered)return;c._csRoseEntered=true;const rivals=csOwn(side==='p'?'e':'p').filter(Boolean).slice(0,2);rivals.forEach(x=>csRoseApplyMark(x,1));if(rivals.length)toast('DOMINIO DE LAS ROSAS MALDITAS: '+rivals.length+' criaturas reciben Marca de Rosa.')}
async function csRoseUseSkill(side,c){const rivalSide=side==='p'?'e':'p',rivals=csOwn(rivalSide).map((x,i)=>({c:x,i})).filter(x=>x.c);if(!rivals.length)return false;if(!c._csRoseGardenUsedDuel&&csGrave(side).filter(x=>csIs(x)).length>=3){const activate=side==='p'?confirm('JARDÍN DE LA MUERTE: ¿activarlo durante 2 turnos?\nAceptar = Jardín · Cancelar = Pétalo'):true;if(activate){c._csRoseGardenUsedDuel=true;c._csRoseGardenUntil=turnNo+1;rivals.forEach(x=>csRoseApplyMark(x.c,1));toast('JARDÍN DE LA MUERTE activo durante 2 turnos.');return true}}if(c._csRosePetalTurn===turnNo){toast('PÉTALO DE LA MUERTE ya fue usado este turno.');return false}const pick=side==='p'?await chooseMagicTarget('PÉTALO DE LA MUERTE · ELIGE OBJETIVO',rivals,side):rivals.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!pick)return false;const t=pick.c;c._csRosePetalTurn=turnNo;if((t._csRoseMarks||0)>=3){t._csRoseMarks=0;t.atk+=(t._csRoseAtkLoss||0);t.def+=(t._csRoseDefLoss||0);t._csRoseAtkLoss=0;t._csRoseDefLoss=0;t._csRoseCannotAttackTurn=turnNo;if(side==='p')ehpv-=2000;else phpv-=2000;toast('PÉTALO DE LA MUERTE: 3 Marcas detonan · 2000 HP directo · ataque bloqueado.');update();return true}csRoseApplyMark(t,1);toast('PÉTALO DE LA MUERTE: '+t.name+' recibe una Marca de Rosa.');update();return true}
...
function csHorusEye(side,target,amount){
 const h=csOwn(side).find(x=>csIs(x,'CS-004'));
 if(!h||!target||target===h||!csIs(target)||h._csHorusEyeTurn===turnNo)return{target,amount};
 h._csHorusEyeTurn=turnNo;
 const reduced=Math.max(0,Math.floor((Number(amount)||0)*.5));
...
function csSubworldRelicFind(side,id){const arr=side==='p'?playerCards:enemyCards;for(let i=0;i<arr.length;i++){const x=arr[i],eq=nemesisEquipmentSlots(x)?.relic;if(x&&eq?.sourceId===id)return{card:x,eq,i}}return null}
function csSubworldRelicCleanup(side,id){
 if(id==='CS-017'){csOwn(side).forEach(x=>{if(!x)return;const a=x._csTartarusAuraAtk||0,d=x._csTartarusAuraDef||0;if(a)x.atk=Math.max(0,x.atk-a);if(d)x.def=Math.max(0,x.def-d);delete x._csTartarusAuraAtk;delete x._csTartarusAuraDef})}
 if(id==='CS-018'){const arr=side==='p'?enemyCards:playerCards;arr.forEach(x=>{if(!x)return;const a=x._csThroneDebuffAtk||0,d=x._csThroneDebuffDef||0;if(a)x.atk+=a;if(d)x.def+=d;delete x._csThroneDebuffAtk;delete x._csThroneDebuffDef})}
}
function csSubworldRelicSync(side){
 const heart=csSubworldRelicFind(side,'CS-017');
 if(heart){const souls=Math.min(5,heart.eq.souls||0),want=souls*300+(souls>=5?500:0);csOwn(side).forEach(x=>{if(!x||x.family!=='caballeros-submundo')return;const oa=x._csTartarusAuraAtk||0,od=x._csTartarusAuraDef||0;x.atk=Math.max(0,(x.atk||0)-oa+want);x.def=Math.max(0,(x.def||0)-od+want);x._csTartarusAuraAtk=want;x._csTartarusAuraDef=want})}
 const throne=csSubworldRelicFind(side,'CS-018');
 if(throne){const souls=Math.min(5,throne.eq.enemySouls||0),want=souls*300,arr=side==='p'?enemyCards:playerCards;arr.forEach(x=>{if(!x||x.type!=='monster')return;const oa=x._csThroneDebuffAtk||0,od=x._csThroneDebuffDef||0;x.atk=Math.max(0,(x.atk||0)+oa-want);x.def=Math.max(0,(x.def||0)+od-want);x._csThroneDebuffAtk=want;x._csThroneDebuffDef=want})}
 update()
}

async function csSubworldSpellMagic(side,m){
 if(!m||m.family!=='caballeros-submundo'||m.subtype!=='spell')return false;
 const own=side==='p'?playerCards:enemyCards,enemy=side==='p'?enemyCards:playerCards,grave=csGrave(side);
 if(m.id==='CS-019'){
  const knights=own.filter(x=>x&&x.family==='caballeros-submundo'&&x.type==='monster'),fallen=grave.filter(x=>x&&x.family==='caballeros-submundo'&&x.type==='monster');
  const bonus=Math.min(5,fallen.length)*500;knights.forEach(x=>{x.atk+=bonus;x.def+=bonus;x._csMoonBonusAtk=(x._csMoonBonusAtk||0)+bonus;x._csMoonBonusDef=(x._csMoonBonusDef||0)+bonus;x._immortalUntil=Math.max(x._immortalUntil||0,turnNo+1)});
  const total=knights.length+fallen.length,ultimate=!window['__csMoonUltimate_'+side]&&total>=3;
  if(ultimate){window['__csMoonUltimate_'+side]=true;if(side==='p')phpv=Math.min(playerMaxHp,phpv+3000);else ehpv=Math.min(enemyMaxHp,ehpv+3000);knights.forEach(x=>{x.atk+=3000;x.def+=3000;x._csMoonUltimateAtk=(x._csMoonUltimateAtk||0)+3000;x._csMoonUltimateDef=(x._csMoonUltimateDef||0)+3000;x._immortalUntil=Math.max(x._immortalUntil||0,turnNo+1)});const free=own.findIndex(x=>!x);if(free>=0&&fallen.length){const pick=fallen.sort((a,b)=>(b.atk||0)-(a.atk||0))[0],gi=grave.indexOf(pick);if(gi>=0){grave.splice(gi,1);own[free]={...pick,_immortalUntil:turnNo};(side==='p'?playerModes:enemyModes)[free]='ATAQUE';await place(side,free,own[free]);await flip(side,free);await setMode(side,free,'ATAQUE')}}toast('ECLIPSE DE LA LUNA INMORTAL: Campo protegido · +3000 HP · resurrección y poder lunar activados.')}else toast('ESCUDO DE LUNA: Barrera eterna y poder de los caídos activados.');update();return true;
 }
 if(m.id==='CS-020'){
  const targets=enemy.map((x,i)=>({c:x,i})).filter(o=>o.c&&o.c.type==='monster');if(!targets.length){toast('RAYO DEL SUBMUNDO: no hay objetivo enemigo.');return false}
  const pick=side==='p'?await chooseMagicTarget('RAYO DEL SUBMUNDO · ELIGE OBJETIVO',targets,side==='p'?'e':'p'):targets.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!pick)return false;
  const fallen=Math.min(5,grave.filter(x=>x&&x.family==='caballeros-submundo'&&x.type==='monster').length),cut=5000+fallen*1000;pick.c.atk=Math.max(0,(pick.c.atk||0)-cut);pick.c.def=Math.max(0,(pick.c.def||0)-cut);pick.c._csRaySealUntil=turnNo+1;
  let destroyed=false;if(pick.c.def<=0){const victim=pick.c;await destroyCard(side==='p'?'e':'p',pick.i,'effect');destroyed=!(side==='p'?enemyCards:playerCards)[pick.i];if(destroyed){const divine=String(victim.rarity||'').includes('divina');const dmg=divine?3500:2500;if(side==='p')ehpv=Math.max(0,ehpv-dmg);else phpv=Math.max(0,phpv-dmg)}}
  const total=own.filter(x=>x&&x.family==='caballeros-submundo'&&x.type==='monster').length+grave.filter(x=>x&&x.family==='caballeros-submundo'&&x.type==='monster').length;
  if(!window['__csRayUltimate_'+side]&&total>=5){window['__csRayUltimate_'+side]=true;enemy.forEach(x=>{if(x&&x.type==='monster'){x.atk=Math.max(0,(x.atk||0)-5000);x.def=Math.max(0,(x.def||0)-5000)}});toast('TORMENTA DEL FIN DEL SUBMUNDO: todos los enemigos pierden 5000 ATK/DEF.')}else toast('RAYO DEL SUBMUNDO: impacto de '+cut+' ATK/DEF'+(destroyed?' · objetivo destruido':'')+'.');update();return true;
 }
 return false;
}
async function csSubworldRelicMagic(side,r){
 if(!r||r.family!=='caballeros-submundo'||r.subtype!=='relic')return false;
 const arr=side==='p'?playerCards:enemyCards;const i=side==='p'?await magicAllyIndex(side,`ELIGE PORTADOR PARA ${r.name}`):csSubworldArmorEquipTarget(side);
 if(i<0||!arr[i]||arr[i].family!=='caballeros-submundo'){toast(`${r.name}: requiere un Caballero o Monstruo del Submundo.`);return false}
 nemesisEquip(side,i,'relic',r,{flag:`_${r.effect}`});const eq=nemesisEquipmentSlots(arr[i])?.relic;
 if(eq?.sourceId==='CS-017')eq.souls=0;
 if(eq?.sourceId==='CS-018')eq.enemySouls=0;
 csSubworldRelicSync(side);toast(`${r.name} equipada y operativa en la ranura RELIQUIA.`);return true
}
function csSubworldRelicOnDestroyed(victimSide,victim){
 if(!victim)return;
 if(victim.family==='caballeros-submundo'){const h=csSubworldRelicFind(victimSide,'CS-017');if(h&&(h.eq.souls||0)<5){h.eq.souls=(h.eq.souls||0)+1;toast(`CORAZÓN DEL TÁRTARO: ALMA ${h.eq.souls}/5.`);csSubworldRelicSync(victimSide)}}
 if(victim.type==='monster'){const owner=victimSide==='p'?'e':'p',t=csSubworldRelicFind(owner,'CS-018');if(t&&(t.eq.enemySouls||0)<5){t.eq.enemySouls=(t.eq.enemySouls||0)+1;toast(`TRONO DE LAS ALMAS PERDIDAS: ALMA ENEMIGA ${t.eq.enemySouls}/5.`);csSubworldRelicSync(owner)}}
}
function csSubworldRelicNegateMagic(casterSide,c){
 if(!c||c.type!=='magic')return false;const owner=casterSide==='p'?'e':'p',t=csSubworldRelicFind(owner,'CS-018');
 if(!t||(t.eq.enemySouls||0)<3||t.eq.negateTurn===turnNo)return false;t.eq.negateTurn=turnNo;toast(`TRONO MALDITO: ${c.name} es NEGADA automáticamente.`);return true
}
function csRelicSkillDescriptor(c){
 const eq=nemesisEquipmentSlots(c)?.relic;if(!eq)return null;
 if(eq.sourceId==='CS-017'&&(eq.souls||0)>=5&&!eq.ultimateUsed)return{name:'PUERTAS DEL TÁRTARO',kind:'caballerosSubmundo',action:'tartarusGates',desc:'Consume 5 ALMAS e invoca 1 Caballero del Submundo desde tu Cementerio.'};
 if(eq.sourceId==='CS-018'&&(eq.enemySouls||0)>=3&&!eq.ultimateUsed)return{name:'JUICIO DEL INFRAMUNDO',kind:'caballerosSubmundo',action:'underworldJudgement',desc:'Consume 3 ALMAS ENEMIGAS y somete al monstruo enemigo más poderoso durante este turno.'};
 return null
}
async function csSubworldRelicUltimate(side,c,action){
 const eq=nemesisEquipmentSlots(c)?.relic;if(!eq||eq.ultimateUsed)return false;
 if(action==='tartarusGates'){
  if(eq.sourceId!=='CS-017'||(eq.souls||0)<5)return false;const grave=csGrave(side),arr=side==='p'?playerCards:enemyCards,modes=side==='p'?playerModes:enemyModes,free=arr.findIndex(x=>!x),valid=grave.map((x,i)=>({c:x,i})).filter(o=>o.c&&o.c.family==='caballeros-submundo'&&o.c.type==='monster');
  if(free<0||!valid.length){toast('PUERTAS DEL TÁRTARO: falta espacio o Caballero en el Cementerio.');return false}
  const pick=side==='p'?await chooseMagicTarget('PUERTAS DEL TÁRTARO · ELIGE CABALLERO',valid,side):valid.sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!pick)return false;
  eq.ultimateUsed=true;eq.souls=0;csSubworldRelicSync(side);const revived={...pick.c};grave.splice(pick.i,1);arr[free]=revived;modes[free]='ATAQUE';await place(side,free,revived);await flip(side,free);await setMode(side,free,'ATAQUE');revived._csTartarusSummonedTurn=turnNo;toast('PUERTAS DEL TÁRTARO: '+revived.name+' regresa con sus estadísticas actuales.');return true
 }
 if(action==='underworldJudgement'){
  if(eq.sourceId!=='CS-018'||(eq.enemySouls||0)<3)return false;const enemy=side==='p'?enemyCards:playerCards,targets=enemy.map((x,i)=>({c:x,i})).filter(o=>o.c&&o.c.type==='monster').sort((a,b)=>(b.c.atk||0)-(a.c.atk||0));if(!targets.length)return false;
  const pick=side==='p'?await chooseMagicTarget('JUICIO DEL INFRAMUNDO · ELIGE MONSTRUO',targets,side==='p'?'e':'p'):targets[0];if(!pick)return false;
  eq.ultimateUsed=true;eq.enemySouls-=3;csSubworldRelicSync(side);pick.c._csThroneControlUntil=turnNo;pick.c._csThroneCannotAttackUntil=turnNo;pick.c._csThroneOwner=side;toast('JUICIO DEL INFRAMUNDO: '+pick.c.name+' queda sometido al Trono durante este turno.');return true
 }
 return false
}
...
function csClearTurn(){
 for(const arr of [playerCards,enemyCards])arr.forEach(c=>{
  ...
  if(csIs(c,'CS-007')){
   if(c._csVenuzShinyTempAtk&&c._csVenuzShinyTempUntil<turnNo){c.atk=Math.max(0,c.atk-c._csVenuzShinyTempAtk);delete c._csVenuzShinyTempAtk;delete c._csVenuzShinyTempUntil}
   if(c._csVenuzShinyFinalAtk&&c._csShinyEclipseUntil<turnNo){c.atk=Math.max(0,c.atk-c._csVenuzShinyFinalAtk);c.def=Math.max(0,c.def-(c._csVenuzShinyFinalDef||0));delete c._csVenuzShinyFinalAtk;delete c._csVenuzShinyFinalDef;delete c._csShinyEclipseUntil;delete c._csShinyFloorAtk;delete c._csShinyFloorDef}
  }
...
function skillFor(c){const armorSkill=csArmorSkillDescriptor(c);if(armorSkill)return armorSkill;if(csIs(c)&&c.type==='monster')return csSkillDescriptor(c);if(idrIs(c)&&(c.type==='monster'||c.type==='fusion'))return idrSkillDescriptor(c);if(mgrIs(c)&&c.type==='monster')return mgrSkillDescriptor(c);if(dmIs(c)&&c.type==='monster')return dmSkillDescriptor(c);if(c?.externalCard&&c.type==='monster')return extAbilityDescriptor(c);if(!c||c.type==='magic'||c.type==='trap'||c.effect==='phantomReflect'||c.id==='apolo-guardian-solar')return null;const custom={
 ...
 'strategic-mago-vacio':{name:'DISTORSIÓN / PORTAL DEL VACÍO',kind:'strategicVoidMage',value:1,desc:'Anula una habilidad rival y permite recuperar una criatura del Cementerio una vez por duelo.'},
 'strategic-prometeo':{name:'FUEGO / REGALO / LLAMA PRIMORDIAL',kind:'strategicPrometheus',value:1,desc:'Reduce DEF, se potencia por 2 turnos y tras 3 turnos desbloquea Llama Primordial.'},
 'limited-dios-vacio-eterno':{name:'PODER DEL VACÍO ETERNO',kind:'eternalVoidGod',value:1,desc:'Devora poder, colapsa habilidades y desbloquea FIN DEL UNIVERSO tras 3 turnos.'},
...
async function destroyEnemyEquipment(side,count=1,source=null){
 ...
 for(let n=0;n<count&&options.length;n++){
  ...
  else {const removed=nemesisUnequip(targetSide,pick.i,pick.kind,{broken:true,toGrave:true,reason:`destruido por ${source?.name||'Poder divino'}`});if(!removed){pcLog(`${pick.label} resiste la destrucción.`,'effect');continue}}
...
async function resolveBattle(attSide,ai,defSide,di){
 ...
 csCerberusBeforeAttack(attSide,A);csPegasusBeforeAttack(attSide,A);csSubworldArmorBeforeAttack(attSide,A);csSubworldWeaponBeforeCombat(attSide,A,D);if(A._csPlutoVengeance){A._csPlutoVengeanceConsumedTurn=turnNo}
 ...
 const rewardAres=()=>{if(A.id==="anc-ares"){A.atk+=500;toast(`Furia del Conquistador: Ares gana +500 ATK (${A.atk}).`)}};const dm=(defSide==='p'?playerModes:enemyModes)[di]||'ATAQUE';await (defSide==='e'?revealEnemy(di):revealPlayer(di));const shieldBonus=D._shieldPending?(Number(D._shieldBonus)||0):0;const defenseValue=A._treasurePiercing?0:(dm==='DEFENSA'?D.def:D.atk)+shieldBonus;const diff=A.atk-defenseValue;if(shieldBonus)toast(`${D.name}: protección de habilidad aporta +${shieldBonus} DEF.`);if(dm==='DEFENSA'){v188Sound('defense');v15Flash('defense');nemesisBattleResolution('DEFENSA',D.name,diff>0?'DEFENSA SUPERADA':diff<0?'BLOQUEO PERFECTO':'CHOQUE IGUALADO')}else{nemesisBattleResolution('ATAQUE',A.name,diff>0?`IMPACTO +${diff}`:diff<0?'CONTRAATAQUE':'COLISIÓN TOTAL')}await attackAnim(attSide,ai,defSide,di,A,Math.max(0,diff));if(attSide==='e')clearNextEnemyShields();else if(shieldBonus){delete D._shieldBonus;delete D._shieldPending}if(A.effect==='royalExecution'&&(D.def||0)<=4000){await destroyCard(defSide,di,'combat');strategicClownLastJoke(D,A);royalAfterKill(attSide,ai,D);await ghostAfterKill(attSide,ai,D);await aresOnKill(attSide,ai,D);await treasureOnBattleKill(attSide,A);await idrAfterKill(attSide,A);csSubworldWeaponAfterKill(attSide,A);await nemesisDmAfterKill(attSide,A,D);toast(`EJECUCIÓN: ${D.name} es destruida por la Corona Maldita.`);update();return}if(dm==='DEFENSA'){
 if(diff>0){
  await destroyCard(defSide,di,'combat');strategicClownLastJoke(D,A);royalAfterKill(attSide,ai,D);await ghostAfterKill(attSide,ai,D);await aresOnKill(attSide,ai,D);await treasureOnBattleKill(attSide,A);await idrAfterKill(attSide,A);csSubworldWeaponAfterKill(attSide,A);await nemesisDmAfterKill(attSide,A,D);rewardAres();
  ...
  toast(`¡Muro impenetrable! El atacante rebota y pierde ${rebote} HP.`);mgrAfterSurvive(defSide,D);csSubworldArmorAfterSurvive(defSide,D);csSubworldWeaponAfterSurvive(defSide,D,A);
 }else{
 ...
 if(diff>0){await destroyCard(defSide,di,'combat');strategicClownLastJoke(D,A);royalAfterKill(attSide,ai,D);await ghostAfterKill(attSide,ai,D);await aresOnKill(attSide,ai,D);await treasureOnBattleKill(attSide,A);await idrAfterKill(attSide,A);csSubworldWeaponAfterKill(attSide,A);await nemesisDmAfterKill(attSide,A,D);rewardAres();let hpDiff=(defSide==='e'?ghostReduceIncomingHpDamage(diff,A):diff);hpDiff=aresFrontLineReduction(defSide,di,hpDiff);const csPierce=csGoldenPiercingDamage(attSide,A,D);if(csPierce>hpDiff){hpDiff=csPierce;toast('ÚLTIMO JUICIO: el daño perforante aumenta el impacto a '+hpDiff+'.')}if(defSide==='e')ehpv-=hpDiff;else phpv-=hpDiff;damageFx(hpDiff,defSide)}else if(diff<0){await destroyCard(attSide,ai,'combat');strategicClownLastJoke(A,D);mgrAfterSurvive(defSide,D);csSubworldArmorAfterSurvive(defSide,D);csSubworldWeaponAfterSurvive(defSide,D,A);if(attSide==='p')phpv-=Math.abs(diff);else ehpv-=Math.abs(diff);damageFx(Math.abs(diff),attSide)}else{await destroyCard(attSide,ai,'combat');strategicClownLastJoke(A,D);await destroyCard(defSide,di,'combat');strategicClownLastJoke(D,A)}update()}
...
async function idrAfterKill(side,c){
 ...
 if(c.id==='IDR-009'&&c._idrCrownKillTurn!==turnNo){c.atk+=500;c._idrCrownKillTurn=turnNo;toast('CORONA CARMESÍ: +500 ATK permanente.')}
 if(c._idrEmperorSword)idrAddMark(c,1);
}
function idrOwn(side){return side==='p'?playerCards:enemyCards}
function idrRival(side){return side==='p'?enemyCards:playerCards}
function idrGrave(side){return side==='p'?playerGrave:enemyGrave}
function idrModes(side){return side==='p'?playerModes:enemyModes}
function idrQueue(side){return side==='p'?deckQueue:enemyQueue}
function idrTransformed(c){return !!c&&(!!c._idrTransformedFrom||!!c.transformOrigin||['IDR-009','IDR-010'].includes(c.id))}
function idrHasSky(side){return side==='p'?!!window.__idrSkyP:!!window.__idrSkyE}
function idrHasCrown(side){return idrOwn(side).some(c=>c?._idrCrown)}
function idrSync(){
 for(const side of ['p','e']){
  const own=idrOwn(side),guard=own.some(c=>idrIs(c)&&c.id==='IDR-006'),emperor=own.find(c=>idrIs(c)&&c.id==='IDR-008'),sky=idrHasSky(side);
  own.forEach(c=>{
   if(!idrIs(c)||['magic','trap'].includes(c.type))return;
   const oldD=c._idrGuardAura||0,wD=guard&&c.id!=='IDR-006'?300:0;if(oldD!==wD){c.def=Math.max(0,c.def-oldD+wD);c._idrGuardAura=wD}
   const oldS=c._idrSkyAura||0,wS=sky?400:0;if(oldS!==wS){c.atk=Math.max(0,c.atk-oldS+wS);c.def=Math.max(0,c.def-oldS+wS);c._idrSkyAura=wS}
   const oldE=c._idrEmperorAura||0,wE=emperor&&c!==emperor?idrMarks(c)*200:0;if(oldE!==wE){c.atk=Math.max(0,c.atk-oldE+wE);c._idrEmperorAura=wE}
  })
 }
}
function idrConsumeReserve(side,id){
 if(side==='p'){
  let i=handState.indexOf(id);if(i>=0){handState.splice(i,1);renderHand();return true}
  i=deckQueue.indexOf(id);if(i>=0){deckQueue.splice(i,1);return true}
 }else{
  const q=enemyQueue,i=q.findIndex(x=>(typeof x==='string'?x:x?.id)===id);if(i>=0){q.splice(i,1);return true}
 }
 return false
}
async function idrTransform(side,i,newId){
 const own=idrOwn(side),modes=idrModes(side),old=own[i],next=card(newId);if(!old||!next||!idrConsumeReserve(side,newId))return false;
 const g=board?.[side]?.[i];if(g){try{scene.remove(g)}catch(e){}board[side][i]=null}
 const n={...next,_idrTransformedFrom:old.id,_idrAscension:idrMarks(old)};own[i]=n;modes[i]=modes[i]||'ATAQUE';
 await place(side,i,n);await flip(side,i);await setMode(side,i,modes[i]);await idrOnSummon(side,i,n,true);
 if(newId==='IDR-009'){if(side==='p'){ehpv=Math.max(0,ehpv-800);damageFx(800,'e')}else{phpv=Math.max(0,phpv-800);damageFx(800,'p')}}
 if(newId==='IDR-010'){own.filter(idrIs).forEach(x=>{x.atk+=700;x.def+=700;x._idrThroneBonus=(x._idrThroneBonus||0)+700})}
 idrSync();update();toast('ASCENSIÓN: '+old.name+' → '+n.name);return true
}
async function idrTryTransform(side,i){
 const c=idrOwn(side)[i];if(!c)return false;
 if(c.id==='IDR-001'&&idrMarks(c)>=2)return idrTransform(side,i,'IDR-009');
 if(c.id==='IDR-008'&&idrMarks(c)>=4)return idrTransform(side,i,'IDR-010');
 return false
}
function idrRemoveMaterial(side,i){
 const own=idrOwn(side),grave=idrGrave(side),modes=idrModes(side),c=own[i];if(!c)return null;
 const g=board?.[side]?.[i];if(g){try{scene.remove(g)}catch(e){}board[side][i]=null}
...
async function idrFusion(side,fusionId){
 ...
 else{if(side==='p')window.__idrSkyP=true;else window.__idrSkyE=true;idrSync()}
 update();toast('FUSIÓN IMPERIO DRAGÓN: '+n.name);return true
}
function idrSkillDescriptor(c){
 if(!idrIs(c)||c.type==='magic'||c.type==='trap')return null;
 const own=(typeof playerCards!=='undefined'&&playerCards.includes(c))?playerCards:enemyCards;
 const hasReserve=id=>side=>true;
 if((c.id==='IDR-003'||c.id==='IDR-004')&&own.some(x=>x?.id==='IDR-003')&&own.some(x=>x?.id==='IDR-004'))return{name:'FUSIÓN ECLIPSE',kind:'imperioDragon',action:'fusion19',desc:'Fusiona IDR-003 + IDR-004 en Dragón Eclipse de la Corona.'};
 if((c.id==='IDR-008'||idrTransformed(c))&&own.some(x=>x?.id==='IDR-008')&&own.some(x=>idrIs(x)&&idrTransformed(x)))return{name:'FUSIÓN EMPERADOR DEL FIN',kind:'imperioDragon',action:'fusion20',desc:'Fusiona una forma transformada + IDR-008.'};
 if(c.id==='IDR-001'&&idrMarks(c)>=2)return{name:'ASCENSIÓN CARMESÍ',kind:'imperioDragon',action:'transform',desc:'Transforma a Dragón Carmesí Imperial.'};
 if(c.id==='IDR-008'&&idrMarks(c)>=4)return{name:'ASCENSIÓN SUPREMA',kind:'imperioDragon',action:'transform',desc:'Transforma a Emperador Dragón NÉMESIS.'};
 const map={
  'IDR-001':['IMPULSO CARMESÍ','mark'],'IDR-002':['FURIA ESCARLATA','fury'],'IDR-003':['ALIENTO INCINERADOR','burn'],
  'IDR-004':['LANZA DEL CATACLISMO','cataclysm'],'IDR-005':['VUELO SUPREMO','flight'],'IDR-006':['ESCAMAS DE LA FORJA','guard'],
  'IDR-007':['VÓRTICE DEL ABISMO','vortex'],'IDR-008':['INFIERNO DOMINANTE','dominion'],'IDR-009':['CORONA CARMESÍ','crown'],
  'IDR-010':['TRONO DE LOS MIL DRAGONES','throne'],'IDR-019':['ECLIPSE DRACÓNICO','eclipse'],'IDR-020':['APOCALIPSIS IMPERIAL','apocalypse']
 };
 const x=map[c.id];return x?{name:x[0],kind:'imperioDragon',action:x[1],desc:c.desc||x[0]}:null
}
async function idrUseSkill(side,i,c,sk){
 const own=idrOwn(side),riv=idrRival(side),rs=side==='p'?'e':'p';
 if(sk.action==='transform')return idrTryTransform(side,i);if(sk.action==='fusion19')return idrFusion(side,'IDR-019');if(sk.action==='fusion20')return idrFusion(side,'IDR-020');
 if(sk.action==='mark'){idrAddMark(c,1);return true}
 if(sk.action==='fury'){c.atk+=500;c._idrFuryBonus=(c._idrFuryBonus||0)+500;c._dmUnlimitedAttacksTurn=turnNo;return true}
 if(sk.action==='burn'){const j=riv.findIndex(x=>x&&(x.type==='magic'||x.type==='trap'));if(j>=0){await destroyCard(rs,j);c.atk+=500;c._idrBreathBonus=(c._idrBreathBonus||0)+500}return true}
 if(sk.action==='cataclysm'){const n=riv.filter(Boolean).length*400;if(side==='p'){ehpv=Math.max(0,ehpv-n);damageFx(n,'e')}else{phpv=Math.max(0,phpv-n);damageFx(n,'p')}return true}
 if(sk.action==='flight'){let n=0;for(let j=riv.length-1;j>=0&&n<2;j--)if(riv[j]){await destroyCard(rs,j);n++}return true}
 if(sk.action==='guard'){const j=side==='p'?await magicAllyIndex(side,'ESCAMAS DE LA FORJA · ELIGE CARTA'):own.findIndex(idrIs);if(j<0)return false;own[j]._idrProtectedUntil=turnNo;return true}
 if(sk.action==='vortex'){const t=riv.map((c,j)=>({c,j})).filter(x=>x.c).sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!t)return false;const gain=t.c.atk||0;await destroyCard(rs,t.j);c.atk+=gain;c._idrVortexBonus=(c._idrVortexBonus||0)+gain;return true}
 if(sk.action==='dominion'){const t=riv.map((c,j)=>({c,j})).filter(x=>x.c).sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(!t)return false;await destroyCard(rs,t.j);c.atk+=500;if(side==='p'){ehpv=Math.max(0,ehpv-500);damageFx(500,'e')}else{phpv=Math.max(0,phpv-500);damageFx(500,'p')}return true}
 if(sk.action==='crown'){c.atk+=500;return true}
 if(sk.action==='throne'){let n=0;for(let j=riv.length-1;j>=0&&n<2;j--)if(riv[j]){await destroyCard(rs,j);n++}c._idrSecondAttackTurn=turnNo;return true}
 if(sk.action==='eclipse'){c._idrMultiAttackTurn=turnNo;return true}
 if(sk.action==='apocalypse'){let n=0;for(let j=riv.length-1;j>=0&&n<3;j--)if(riv[j]){await destroyCard(rs,j);n++}c.atk+=n*500;c._idrApocalypseBonus=(c._idrApocalypseBonus||0)+n*500;return true}
 return false
}
async function idrApplyMagic(side,c){
 const own=idrOwn(side);
 if(c.id==='IDR-011'){const q=idrQueue(side),idx=q.findIndex(x=>{const z=side==='p'?card(x):x;return idrIs(z)&&z.type==='monster'&&!z.transformOrigin});if(idx>=0){if(side==='p'){const id=q.splice(idx,1)[0];handState.push(id);renderHand()}else{const x=q.splice(idx,1)[0];q.unshift(x)}}const t=own.find(x=>idrIs(x)&&idrTransformed(x));if(t)idrAddMark(t,1);return true}
 if(c.id==='IDR-012'){const j=side==='p'?await magicAllyIndex(side,'RUGIDO DE ASCENSIÓN · ELIGE DRAGÓN'):own.findIndex(idrIs);if(j<0)return false;idrAddMark(own[j],1);await idrTryTransform(side,j);return true}
 if(c.id==='IDR-013'){if(side==='p')window.__idrSkyP=true;else window.__idrSkyE=true;idrSync();return true}
 if(c.id==='IDR-016'||c.id==='IDR-017'||c.id==='IDR-018'){const j=side==='p'?await magicAllyIndex(side,'ELIGE PORTADOR · '+c.name):own.findIndex(idrIs);if(j<0)return false;const t=own[j];
  if(c.id==='IDR-016'){nemesisEquip(side,j,'weapon',c,{atkBonus:1400,flag:'_idrEmperorSword'});t._idrEmperorSword=true;t._treasurePiercing=true}
  if(c.id==='IDR-017'){nemesisEquip(side,j,'weapon',c,{atkBonus:1000,defBonus:400,flag:'_idrWingSpear'});t._idrWingSpear=true}
  if(c.id==='IDR-018'){nemesisEquip(side,j,'relic',c,{flag:'_idrCrown'});t._idrCrown=true}
  return true}
 return false
}
async function idrTryAttackTrap(attackerIndex,targetIndex){
 const target=playerCards[targetIndex],ti=playerCards.findIndex(c=>c?.id==='IDR-014');if(ti<0||!idrIs(target)||!enemyCards[attackerIndex])return false;
 const a=enemyCards[attackerIndex];await revealPlayer(ti);target._shieldBonus=(target._shieldBonus||0)+1200;target._shieldPending=true;a.atk=Math.max(0,a.atk-600);a._idrScaleDebuff=(a._idrScaleDebuff||0)+600;await destroyCard('p',ti);toast('CONTRAATAQUE DE ESCAMAS: +1200 DEF · atacante -600 ATK.');return false
}
async function idrPreventDestroy(side,i,victim){
 if(!idrIs(victim)||victim?._idrFusionMaterial)return false;
 if((victim._idrProtectedUntil||-1)>=turnNo){delete victim._idrProtectedUntil;idrAddMark(victim,1);toast('ESCAMAS DE LA FORJA evita la destrucción.');return true}
 if(victim.id==='IDR-008'){const grave=idrGrave(side),gi=grave.findIndex(idrIs);if(gi>=0){grave.splice(gi,1);toast('EMPERADOR INFERNAL destierra 1 carta del Cementerio y sobrevive.');return true}}
 if(victim.id==='IDR-020'){const own=idrOwn(side),total=own.reduce((n,c)=>n+idrMarks(c),0);if(total>=3){let need=3;for(const c of own){if(!c||need<=0)continue;const take=Math.min(need,idrMarks(c));c._idrAscension=idrMarks(c)-take;need-=take}toast('EMPERADOR DEL FIN consume 3 Marcas y evita la destrucción.');return true}}
 const ti=idrOwn(side).findIndex(c=>c?.id==='IDR-015'&&!c._idrConsuming);if(ti>=0&&victim.id!=='IDR-015'){const trap=idrOwn(side)[ti];trap._idrConsuming=true;await (side==='p'?revealPlayer(ti):revealEnemy(ti)).catch(()=>{});const riv=idrRival(side),rs=side==='p'?'e':'p',t=riv.map((c,j)=>({c,j})).filter(x=>x.c).sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(t)await destroyCard(rs,t.j);idrRemoveMaterial(side,ti);if(idrTransformed(victim)&&side==='p')await drawPlayerCard();toast('IRA DEL ÚLTIMO DRAGÓN niega la destrucción.');return true}
 return false
}
...
window.NEMESIS_IMPERIO_DRAGON_AUDIT=()=>{const ids=IMPERIO_DRAGON_DECK_IDS.slice(),cards=ids.map(id=>card(id)),handlers=cards.map(c=>({id:c?.id,type:c?.type,handler:!!c&&(
 c.type==='monster'||c.type==='fusion'?!!idrSkillDescriptor(c):c.type==='magic'?['IDR-011','IDR-012','IDR-013','IDR-016','IDR-017','IDR-018'].includes(c.id):c.type==='trap'?['IDR-014','IDR-015'].includes(c.id):false)}));
 return{deck:'IMPERIO_DRAGON',count:ids.length,unique:new Set(ids).size,missing:ids.filter(id=>!card(id)),handlers,systems:{marks:typeof idrAddMark==='function',transform:typeof idrTransform==='function',fusion:typeof idrFusion==='function',magic:typeof idrApplyMagic==='function',traps:typeof idrPreventDestroy==='function',strategy:typeof idrSkillDescriptor==='function'},ok:ids.length===20&&new Set(ids).size===20&&handlers.every(x=>x.handler)}};
window.NEMESIS_RUNTIME_MECHANICS_AUDIT=()=>{const dm=window.NEMESIS_DUEL_MASTER_AUDIT?.(),mgr=window.NEMESIS_MAGO_ROJO_AUDIT?.(),idr=window.NEMESIS_IMPERIO_DRAGON_AUDIT?.(),tr=window.NEMESIS_TREASURE_AUDIT?.();return{dm,mgr,idr,treasures:tr,phases:{valid:Array.isArray(NEMESIS_PHASES)&&NEMESIS_PHASES.includes('ACTION')&&NEMESIS_PHASES.includes('TARGET')&&NEMESIS_PHASES.includes('ENEMY')},ok:!!dm?.ok&&!!mgr?.ok&&!!idr?.ok&&tr?.count===5}};
...
async function mgrUseSkill(side,i,c,sk){
 ...
 if(sk.action==='eclipse'){own.forEach(x=>{if(mgrIs(x)&&x.type==='monster'){x.atk+=600;x._mgrTempAtk=(x._mgrTempAtk||0)+600}});const t=rival.map((x,j)=>({c:x,j})).filter(x=>x.c&&x.c.type!=='magic'&&x.c.type!=='trap').sort((a,b)=>(b.c.atk||0)-(a.c.atk||0))[0];if(t){if(!orbPowerDominion(t.c)){t.c.atk=Math.max(0,t.c.atk-400);t.c._mgrDebuff=(t.c._mgrDebuff||0)+400;}t.c.def=Math.max(0,t.c.def-400);t.c._mgrDefDebuff=(t.c._mgrDefDebuff||0)+400}return true}
...
function nemesisEclipseFlag(side){return side==='p'?'__nemesisEclipseUsedP':'__nemesisEclipseUsedE'}
function nemesisEclipseRival(side){return side==='p'?'e':'p'}
function nemesisEclipseOwnCards(side){return side==='p'?playerCards:enemyCards}
function nemesisEclipseRivalCards(side){return side==='p'?enemyCards:playerCards}
function nemesisEclipseGrave(side){return side==='p'?playerGrave:enemyGrave}
function nemesisEclipseModes(side){return side==='p'?playerModes:enemyModes}
function nemesisEclipseAvailability(side){
 const own=nemesisEclipseOwnCards(side),riv=nemesisEclipseRivalCards(side),grave=nemesisEclipseGrave(side);
 const enemyEquip=riv.some(x=>{const s=nemesisEquipmentSlots(x);return !!s&&['weapon','armor','relic'].some(k=>s[k])});
 return {
  judgement:riv.some(Boolean)||enemyEquip,
  resurrection:grave.some(x=>x&&x.type!=='magic'&&x.type!=='trap')&&own.some(x=>!x),
  silence:riv.some(Boolean),
  ascension:own.some(x=>x&&x.type!=='magic'&&x.type!=='trap'),
  rupture:enemyEquip
 }
}
function nemesisEclipseChoose3(side){
 const defs=[
  {id:'judgement',label:'JUICIO DEL ECLIPSE',txt:'Destierra 1 carta rival ignorando protección normal.'},
  {id:'resurrection',label:'RENACIMIENTO SUPREMO',txt:'Revive 1 monstruo con todos sus efectos disponibles.'},
  {id:'silence',label:'SILENCIO DE NÉMESIS',txt:'Anula y sella 1 carta rival durante este turno.'},
  {id:'ascension',label:'ASCENSIÓN ABSOLUTA',txt:'+3500 ATK/+3500 DEF por 2 turnos y protección inicial.'},
  {id:'rupture',label:'RUPTURA DEL DESTINO',txt:'Destierra 1 arma, armadura o reliquia rival; no puede recuperarse.'}
 ];
 const av=nemesisEclipseAvailability(side);
 if(side!=='p'){
  const preferred=['judgement','silence','ascension','rupture','resurrection'];
  const chosen=preferred.filter(id=>av[id]).slice(0,3);
  for(const id of preferred)if(chosen.length<3&&!chosen.includes(id))chosen.push(id);
  return Promise.resolve(chosen);
 }
 return new Promise(resolve=>{
  document.getElementById('nemesisEclipsePicker')?.remove();
  const overlay=document.createElement('div');overlay.id='nemesisEclipsePicker';
  overlay.style.cssText='position:fixed;inset:0;z-index:10050;background:rgba(0,0,0,.88);display:grid;place-items:center;padding:20px;backdrop-filter:blur(10px)';
  overlay.innerHTML=`<section style="width:min(760px,96vw);background:linear-gradient(180deg,#11091c,#030409);border:1px solid #a85cff;border-radius:18px;box-shadow:0 0 70px #7d28c955;padding:20px;color:#fff"><small style="letter-spacing:.22em;color:#cf9cff">SECRETA NÉMESIS · MS-001</small><h2 style="margin:5px 0;color:#f4ddff">ECLIPSE ABSOLUTO</h2><p>Elige exactamente <b>3 de los 5 poderes</b>.</p><div data-options style="display:grid;gap:9px"></div><div style="display:flex;justify-content:flex-end;gap:10px;margin-top:16px"><button data-cancel class="btn">CANCELAR</button><button data-ok class="btn" disabled>ACTIVAR 0/3</button></div></section>`;
  const box=overlay.querySelector('[data-options]'),selected=new Set();
  defs.forEach(d=>{const b=document.createElement('button');b.type='button';b.className='btn';b.dataset.id=d.id;b.style.cssText='text-align:left;padding:12px;border-color:#57316f;background:#0c0a13';b.innerHTML=`<b>${d.label}</b><br><small>${d.txt}${av[d.id]?'':' · SIN OBJETIVO ACTUAL'}</small>`;b.onclick=()=>{if(selected.has(d.id)){selected.delete(d.id);b.style.outline='none'}else if(selected.size<3){selected.add(d.id);b.style.outline='2px solid #d48cff'}const ok=overlay.querySelector('[data-ok]');ok.disabled=selected.size!==3;ok.textContent='ACTIVAR '+selected.size+'/3'};box.appendChild(b)});
  document.body.appendChild(overlay);
  overlay.querySelector('[data-cancel]').onclick=()=>{overlay.remove();resolve(null)};
  overlay.querySelector('[data-ok]').onclick=()=>{const v=[...selected];overlay.remove();resolve(v)};
 });
}
async function nemesisEclipseBanishMonster(side,i,source){
 const arr=side==='p'?playerCards:enemyCards,modes=nemesisEclipseModes(side),g=board?.[side]?.[i],victim=arr?.[i];if(!victim)return false;
 window.__nemesisEclipseBanished=window.__nemesisEclipseBanished||[];
 window.__nemesisEclipseBanished.push({...victim,_banishedBy:'MS-001'});
 if(g){nemesisBreakAllEquipment(side,i);try{v15Flash('destroy');sfx('destroy');burst(g.position,0xb45cff,64);scene.remove(g)}catch{}}
 if(board?.[side])board[side][i]=null;arr[i]=null;modes[i]=null;
 pcLog(`JUICIO DEL ECLIPSE: ${victim.name} fue DESTERRADA por ${source?.name||'Eclipse de NÉMESIS'}.`,'effect');
 toast(`JUICIO DEL ECLIPSE: ${victim.name} fue desterrada.`);update();return true;
}
async function nemesisEclipseJudgement(side,c){
 const rs=nemesisEclipseRival(side),riv=nemesisEclipseRivalCards(side),options=[];
 riv.forEach((x,i)=>{if(x)options.push({kind:'monster',slot:i,c:x,label:x.name});const s=nemesisEquipmentSlots(x);if(s)for(const k of ['weapon','armor','relic'])if(s[k])options.push({kind:'equipment',slot:i,eqKind:k,c:x,label:s[k].label})});
 if(!options.length){toast('JUICIO DEL ECLIPSE: no hay objetivo rival.');return false}
 let pick=options[0];
 if(side==='p'&&options.length>1){const ch=await chooseMagicTarget('JUICIO DEL ECLIPSE · DESTIERRA 1 CARTA',options.map((o,j)=>({c:{...o.c,name:o.kind==='equipment'?o.label+' · '+o.c.name:o.c.name},i:j})),rs);if(!ch)return false;pick=options[ch.i]}
 if(pick.kind==='monster')return await nemesisEclipseBanishMonster(rs,pick.slot,c);
 const slots=nemesisEquipmentSlots(riv[pick.slot]),eq=slots?.[pick.eqKind];if(!eq)return false;
 window.__nemesisEclipseBanished=window.__nemesisEclipseBanished||[];window.__nemesisEclipseBanished.push({...eq.sourceCard,_banishedBy:'MS-001'});
 nemesisUnequip(rs,pick.slot,pick.eqKind,{broken:false,toGrave:false,reason:'desterrado por Juicio del Eclipse'});
 toast('JUICIO DEL ECLIPSE destierra '+pick.label+'.');update();return true;
}
async function nemesisEclipseResurrection(side,c){
 if(side==='p'&&hadesGraveSelectionBlocked('p')){toast('RENACIMIENTO SUPREMO atraviesa el bloqueo del Cementerio.');}
 const arr=nemesisEclipseOwnCards(side),grave=nemesisEclipseGrave(side),modes=nemesisEclipseModes(side),free=arr.map((x,i)=>x?-1:i).filter(i=>i>=0),valid=grave.map((x,i)=>({c:x,i})).filter(x=>x.c&&x.c.type!=='magic'&&x.c.type!=='trap');
 if(!free.length||!valid.length){toast('RENACIMIENTO SUPREMO: no hay monstruo o espacio disponible.');return false}
 const picked=side==='p'?await chooseMagicTarget('RENACIMIENTO SUPREMO · ELIGE MONSTRUO',valid,side):valid.sort((a,b)=>((b.c.atk||0)+(b.c.def||0))-((a.c.atk||0)+(a.c.def||0)))[0];if(!picked)return false;
 const revived={...picked.c};Object.keys(revived).filter(k=>k.startsWith('_')).forEach(k=>delete revived[k]);const slot=free[0];grave.splice(picked.i,1);arr[slot]=revived;modes[slot]='ATAQUE';revived._nemesisImmediateAttackUntil=turnNo;
 await place(side,slot,revived);await flip(side,slot);await setMode(side,slot,'ATAQUE');toast('RENACIMIENTO SUPREMO: '+revived.name+' vuelve con sus efectos restaurados.');update();return true;
}
async function nemesisEclipseSilence(side){
 const rs=nemesisEclipseRival(side),riv=nemesisEclipseRivalCards(side),valid=riv.map((x,i)=>({c:x,i})).filter(x=>x.c);if(!valid.length){toast('SILENCIO DE NÉMESIS: no hay objetivo rival.');return false}
 const p=side==='p'?await chooseMagicTarget('SILENCIO DE NÉMESIS · ELIGE CARTA',valid,rs):valid.sort((a,b)=>((b.c.atk||0)+(b.c.def||0))-((a.c.atk||0)+(a.c.def||0)))[0];if(!p)return false;
 p.c._strategicSkillNegatedUntil=Math.max(p.c._strategicSkillNegatedUntil||0,turnNo+1);p.c._nemesisSilencedUntil=turnNo;
 toast('SILENCIO DE NÉMESIS: '+p.c.name+' queda anulada y sellada este turno.');pcLog('SILENCIO DE NÉMESIS sella '+p.c.name+'.','effect');return true;
}
async function nemesisEclipseAscension(side){
 const own=nemesisEclipseOwnCards(side),valid=own.map((x,i)=>({c:x,i})).filter(x=>x.c&&x.c.type!=='magic'&&x.c.type!=='trap');if(!valid.length){toast('ASCENSIÓN ABSOLUTA: no hay criatura aliada.');return false}
 const p=side==='p'?await chooseMagicTarget('ASCENSIÓN ABSOLUTA · ELIGE CRIATURA',valid,side):valid.sort((a,b)=>((b.c.atk||0)+(b.c.def||0))-((a.c.atk||0)+(a.c.def||0)))[0];if(!p)return false;
 const x=p.c;x.atk=(x.atk||0)+3500;x.def=(x.def||0)+3500;x._eclipseAscAtk=(x._eclipseAscAtk||0)+3500;x._eclipseAscDef=(x._eclipseAscDef||0)+3500;x._eclipseAscUntil=turnNo+2;x._eclipseProtectedUntil=turnNo+1;
 toast('ASCENSIÓN ABSOLUTA: '+x.name+' obtiene +3500 ATK / +3500 DEF y protección.');update();return true;
}
async function nemesisEclipseRupture(side,c){
 const rs=nemesisEclipseRival(side),riv=nemesisEclipseRivalCards(side),opts=[];
 riv.forEach((x,i)=>{const s=nemesisEquipmentSlots(x);if(s)for(const k of ['weapon','armor','relic'])if(s[k])opts.push({c:x,i,kind:k,label:s[k].label,eq:s[k]})});
 if(!opts.length){toast('RUPTURA DEL DESTINO: no hay equipamiento rival.');return false}
 let pick=opts[0];if(side==='p'&&opts.length>1){const ch=await chooseMagicTarget('RUPTURA DEL DESTINO · ELIGE EQUIPAMIENTO',opts.map((o,j)=>({c:{...o.c,name:o.label+' · '+o.c.name},i:j})),rs);if(!ch)return false;pick=opts[ch.i]}
 window.__nemesisEclipseBanished=window.__nemesisEclipseBanished||[];window.__nemesisEclipseBanished.push({...pick.eq.sourceCard,_banishedBy:'RUPTURA_DEL_DESTINO'});
 nemesisUnequip(rs,pick.i,pick.kind,{broken:false,toGrave:false,reason:'desterrado por Ruptura del Destino'});toast('RUPTURA DEL DESTINO: '+pick.label+' no puede recuperarse este duelo.');update();return true;
}
function nemesisEclipseExpire(){
 for(const arr of [playerCards,enemyCards])arr.forEach(x=>{if(!x)return;if(x._eclipseAscUntil!=null&&turnNo>x._eclipseAscUntil){x.atk=Math.max(0,(x.atk||0)-(x._eclipseAscAtk||0));x.def=Math.max(0,(x.def||0)-(x._eclipseAscDef||0));delete x._eclipseAscAtk;delete x._eclipseAscDef;delete x._eclipseAscUntil;delete x._eclipseProtectedUntil}if(x._nemesisSilencedUntil!=null&&turnNo>x._nemesisSilencedUntil)delete x._nemesisSilencedUntil});
}
async function nemesisAbsoluteEclipseMagic(side,c){
 const flag=nemesisEclipseFlag(side);if(window[flag]){toast('ECLIPSE ABSOLUTO ya fue resuelto por este jugador durante el duelo.');return true}
 const picks=await nemesisEclipseChoose3(side);if(!picks||picks.length!==3)return false;window[flag]=true;
 v15Flash('ultimate');pcLog('ECLIPSE DE NÉMESIS · ECLIPSE ABSOLUTO: '+picks.join(' + '),'effect');
 for(const id of picks){if(id==='judgement')await nemesisEclipseJudgement(side,c);else if(id==='resurrection')await nemesisEclipseResurrection(side,c);else if(id==='silence')await nemesisEclipseSilence(side);else if(id==='ascension')await nemesisEclipseAscension(side);else if(id==='rupture')await nemesisEclipseRupture(side,c);await wait(160)}
 toast('ECLIPSE ABSOLUTO RESUELTO · 3 PODERES ACTIVADOS.');update();return true;
}

async function applyMagic(side,c){strategicVoidMageOnMagic(side);if(c?.effect==='nemesisAbsoluteEclipse')return await nemesisAbsoluteEclipseMagic(side,c);if(c?._nemesisSilencedUntil>=turnNo){toast(c.name+' permanece sellada por SILENCIO DE NÉMESIS.');return true;}
 if(csSubworldRelicNegateMagic(side,c))return true;
 ...
 if(c?.family==='caballeros-submundo'&&c?.subtype==='spell')return await csSubworldSpellMagic(side,c);
 if(c?.family==='caballeros-submundo'&&c?.subtype==='relic')return await csSubworldRelicMagic(side,c);
...
async function enemyPlace(){const free=[0,1,2,3,4].filter(i=>!enemyCards[i]);if(!enemyQueue.length)return -1;const pick=bossAiPickQueueIndex();if(pick<0)return -1;const ec=enemyQueue.splice(pick,1)[0];if(['magic','trap','relic'].includes(ec.type)){
 ...
 return enemySlot}
async function handleSlot(side,i){if(busy||enAnimacionGSAP)return;if(side==='p'&&phase==='PLACE'&&selectedHand>=0&&!playerCards[i]){busy=true;const id=handState[selectedHand],base=card(id);if(base?.family==='imperio-dragon'&&base.type==='fusion'){toast('Esta carta requiere FUSIÓN: activa la habilidad de uno de sus materiales.');busy=false;return}const c={...base};playerCards[i]=c;await v16Cam('PLACE','p',i);await place('p',i,c);await idrOnSummon('p',i,c,false);idrSync();await mgrOnSummon('p',i,c,false);let mode;
...
nemesisBossTurnStart();endPlayerMagicTurn();v172ClosePicker();v171HideAttackConfirm();v17PendingTarget=-1;v181ReturnOverview();v12TargetCamera(false);targetbanner?.classList.add('hidden');
 ...
 try{
  ...
  if(attackers.length&&!targets.length){
   ...
   enemySlot=aiChoice?.attacker??attackers[Math.floor(Math.random()*attackers.length)];
   await idrTryAttackTrap(enemySlot,targets[0]);
...
let nemesisFinishLocked=false;function finish(win,reason=''){if(nemesisFinishLocked||phase==='END')return;nemesisFinishLocked=true;stopBattleRuntime(false);v185HardResetCamera();v172ClosePicker();v171HideAttackConfirm();
 ...
 if(win){
  ...
  const campaignReward=NEMESIS_RETRY_ROSTER.find(r=>(r.battleKey||'guardian')===duelKey);
  const starsWon=retryReward?retryReward.reward:(campaignReward?.reward||100);
 ...
 if(win){
  ...
  else if(isAres)d.innerHTML=`<div class="guardian-defeat-card"><img src="assets/images/campaign3/ares/ares-personaje.png" alt="Ares"><div class="guardian-defeat-dialog"><h2>ARES DERROTADO</h2><p>La guerra se detiene... y surge una risa desde la oscuridad.</p><p class="dark-warning">HADES TE ESPERA</p><p>★ +${starsWon} ESTRELLAS</p>${retryHtml}${rewardHtml}<button class="btn" id="again">CONTINUAR</button></div></div>`;
  else if(isGhostGod)d.innerHTML=`<div class="guardian-defeat-card spectral-victory"><img src="assets/images/dios-fantasma/dios-fantasma.png" alt="Dios Fantasma"><div class="guardian-defeat-dialog"><h2>DIOS FANTASMA DERROTADO</h2><p>Me vengaré...</p><p class="dark-warning">CAMPAÑA III DESBLOQUEADA</p><p>★ +${starsWon} ESTRELLAS</p>${retryHtml}${rewardHtml}<button class="btn" id="again">ENTRAR A CAMPAÑA III</button></div></div>`;
  else if(isSpectralKing)d.innerHTML=`<div class="guardian-defeat-card spectral-victory"><img src="${AS.reyEspectral}" alt="Rey Espectral"><div class="guardian-defeat-dialog"><h2>REY ESPECTRAL DERROTADO</h2><p>La Corona de la Eternidad se rompe y el trono queda en silencio.</p><p class="dark-warning">SIGUIENTE: DIOS FANTASMA</p><p>★ +${starsWon} ESTRELLAS</p>${retryHtml}${rewardHtml}<button class="btn" id="again">VOLVER A CAMPAÑA II</button></div></div>`;
  else if(isSoulKnight)d.innerHTML=`<div class="guardian-defeat-card spectral-victory"><img src="${AS.caballeroAlmas}" alt="Caballero de las Almas"><div class="guardian-defeat-dialog"><h2>CABALLERO DE LAS ALMAS DERROTADO</h2><p>Las almas se dispersan y el camino hacia el Rey Espectral queda abierto.</p><p class="dark-warning">SIGUIENTE: REY ESPECTRAL</p><p>★ +${starsWon} ESTRELLAS</p>${retryHtml}${rewardHtml}<button class="btn" id="again">VOLVER A CAMPAÑA II</button></div></div>`;
  else if(isRa)d.innerHTML=`<div><h1>CAMPAÑA I COMPLETADA</h1><p>Has derrotado a IRA DE RA y superado el poder del Sol ancestral.</p><p class="dark-warning">CAMPAÑA II DESBLOQUEADA</p><p>★ +${starsWon} ESTRELLAS</p><p>La Memory Card guardó tus cartas ganadas, estrellas, colección y mazo.</p>${retryHtml}${rewardHtml}<button class="btn" id="again">VOLVER AL INICIO</button></div>`;
  else if(isDragon)d.innerHTML=`<div class="guardian-defeat-card"><img src="assets/images/dragon-ojo-del-diablo.png" alt="Dragón Ojo del Diablo"><div class="guardian-defeat-dialog"><h2>DRAGÓN OJO DEL DIABLO</h2><p>No soy el más poderoso... ¡JA, JA, JA!</p><p class="dark-warning">IRA DE RA TE ESPERA</p><p>★ +${starsWon} ESTRELLAS</p>${retryHtml}${rewardHtml}<button class="btn" id="again">VOLVER AL MENÚ</button></div></div>`;
  else d.innerHTML=`<div class="guardian-defeat-card"><img src="assets/images/guardian-dragones.webp" alt="Guardián de los Dragones"><div class="guardian-defeat-dialog"><h2>GUARDIÁN DE LOS DRAGONES</h2><p>Oh... me mataste.</p><p class="dark-warning">Pero te enfrentarás a la oscuridad.</p><p>★ +${starsWon} ESTRELLAS</p><p>Sus cartas quedaron desbloqueadas en INTERCAMBIO NÉMESIS.</p>${retryHtml}${rewardHtml}<button class="btn" id="again">CONTINUAR</button></div></div>`
...
window.addEventListener('nemesis-owner-auth',e=>{try{const was=window.__nemesisOwnerLastState,now=!!e.detail?.isOwner;window.__nemesisOwnerLastState=now;nemesisEnsureDeckLibrary();nemesisSyncActiveDeck();if(was!==undefined&&was!==now){if(document.querySelector('.collection-global'))collectionScene();else if(document.querySelector('.menu-home'))menuScene()}nemesisNextFrame(()=>window.NEMESIS_OWNER_AUTH_INJECT?.())}catch(err){console.warn('NÉMESIS owner refresh',err)}});
