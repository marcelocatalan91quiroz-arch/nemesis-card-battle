...
function v171ShowAttackConfirm(i){
 ...
 x.querySelector('#v171attack').onclick=async()=>{
   ...
   try{
     ...
     if(nemesisDmKeepTurnAfterAttack(dmAttacker)||idrKeepTurnAfterAttack(dmAttacker)){setPhase('ACTION',`TU TURNO ${turnNo} · ATAQUE ADICIONAL`,{force:true});battleActions.classList.remove('hidden');return}
     await enemyTurn();
   }catch(err){
