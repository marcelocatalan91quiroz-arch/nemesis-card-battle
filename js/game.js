...
const CABALLEROS_SUBMUNDO_CARDS=[
 ...
 ,{id:'CS-017',name:'Corazón del Tártaro',atk:0,def:0,type:'magic',subtype:'relic',family:'caballeros-submundo',tags:['reliquia','tartaro','almas','caballeros-submundo'],rarity:'mitica-suprema',effect:'csRelicTartarusHeart',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/corazon-del-tartaro.webp',desc:'ALMAS ENCADENADAS: cuando uno de tus Caballeros del Submundo va al Cementerio, obtiene 1 ALMA, máximo 5; cada ALMA da +300 ATK/+300 DEF a tus Caballeros mientras la reliquia esté activa. PODER DEL TÁRTARO: con 5 ALMAS alcanza +1500 ATK/+1500 DEF total para el ejército. RESERVA DE LAS ALMAS: una vez por turno consume 1 ALMA para proteger un Caballero del Cementerio de destierro o destrucción por efecto ese turno. CORAZÓN INMORTAL: paga 2 ALMAS para negar la destrucción de esta reliquia. SINFONÍA DEL INFRAMUNDO: protege a tus Caballeros contra reducciones de ATK/DEF y selección enemiga, salvo ataques. ULTIMATE PUERTAS DEL TÁRTARO: una vez por duelo, con 5 ALMAS, consúmelas e invoca 1 Caballero del Submundo del Cementerio con estadísticas originales; puede actuar desde el siguiente turno.'}
 ,{id:'CS-018',name:'Trono de las Almas Perdidas',atk:0,def:0,type:'magic',subtype:'relic',family:'caballeros-submundo',tags:['reliquia','almas-enemigas','control','caballeros-submundo'],rarity:'ancestral-suprema',effect:'csRelicLostSoulsThrone',caballerosSubmundo:true,img:'assets/images/caballeros-submundo/trono-almas-perdidas.webp',desc:'REINO DE LOS MUERTOS: cuando un monstruo enemigo es destruido por uno de tus Caballeros, obtiene 1 ALMA ENEMIGA; cada una reduce -300 ATK/-300 DEF a los monstruos enemigos, máximo 3. TRONO MALDITO: con 3 ALMAS ENEMIGAS, la primera Mágica o Trampa rival de cada turno es negada. PESO DEL JUICIO: con 2 o más ALMAS ENEMIGAS, los monstruos enemigos no pueden aumentar ATK/DEF por efectos. CORRUPCIÓN DEL ALMA: una vez por turno consume 1 ALMA ENEMIGA para reducir ATK/DEF de 1 monstruo enemigo a 0 hasta fin del turno. TRONO INQUEBRANTABLE: una vez por duelo niega un intento de destruir esta reliquia y gana 1 ALMA ENEMIGA si no alcanzó el máximo. ULTIMATE JUICIO DEL INFRAMUNDO: una vez por duelo, consume 3 ALMAS ENEMIGAS y controla 1 monstruo enemigo durante 1 turno; mantiene estadísticas originales y vuelve al final.'}
];
...
async function applyMagic(side,c){strategicVoidMageOnMagic(side);if(csRelicNegateMagic(side))return true;
