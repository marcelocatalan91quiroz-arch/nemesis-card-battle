...
async function applyExternalMagic(side,c){
 ...
 if(dmIs(c)&&['DM-013','DM-014','DM-015','DM-016','DM-017'].includes(c.id)){
  ...
  if(c.id==='DM-016'){own.forEach(x=>{if(dmIs(x)){x.atk+=1000;x.def+=1000;x._dmCrown=true}});if(side==='p')phpv=Math.min(playerMaxHp,phpv+2000);else ehpv=Math.min(enemyMaxHp,ehpv+2000)}
