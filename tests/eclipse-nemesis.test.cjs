...
A('sin límite global legacy de 11',!game.includes("deck:INITIAL_OWNED.slice(0,11)")&&!game.includes("savedDecks:true,deckLimit:11")&&!game.includes("state.deck.length<11"));
